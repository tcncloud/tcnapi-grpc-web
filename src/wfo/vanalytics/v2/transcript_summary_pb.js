...
goog.exportSymbol('proto.wfo.vanalytics.v2.TranscriptSummaryStatus', null, global);
/**
...
proto.wfo.vanalytics.v2.TranscriptSummary.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.wfo.vanalytics.v2.TranscriptSummaryStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.wfo.vanalytics.v2.TranscriptSummaryStatus}
 */
proto.wfo.vanalytics.v2.TranscriptSummary.prototype.getStatus = function() {
  return /** @type {!proto.wfo.vanalytics.v2.TranscriptSummaryStatus} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.wfo.vanalytics.v2.TranscriptSummaryStatus} value
 * @return {!proto.wfo.vanalytics.v2.TranscriptSummary} returns this
 */
 ...
 * @enum {number}
 */
proto.wfo.vanalytics.v2.TranscriptSummaryStatus = {
  QUEUED: 0,
  QUEUED_ERRORED: -1,
  SUMMARIZED: 1,
