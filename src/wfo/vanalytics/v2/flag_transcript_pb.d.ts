...
export namespace SearchFlagTranscriptsResponse {
  ...
  export class Hit extends jspb.Message {
    ...
    getTranscript(): wfo_vanalytics_v2_transcript_pb.Transcript | undefined;
    setTranscript(value?: wfo_vanalytics_v2_transcript_pb.Transcript): void;
  ...
  export namespace Hit {
    export type AsObject = {
      transcript?: wfo_vanalytics_v2_transcript_pb.Transcript.AsObject,
