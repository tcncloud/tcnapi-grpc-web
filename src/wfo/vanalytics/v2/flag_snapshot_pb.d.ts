...
// file: wfo/vanalytics/v2/flag_snapshot.proto
...
export class FlagSnapshot extends jspb.Message {
  ...
  getDnclListList(): Array<wfo_vanalytics_v2_dncl_list_pb.DnclList>;
  setDnclListList(value: Array<wfo_vanalytics_v2_dncl_list_pb.DnclList>): void;
  addDnclList(value?: wfo_vanalytics_v2_dncl_list_pb.DnclList, index?: number): wfo_vanalytics_v2_dncl_list_pb.DnclList;
...
export namespace FlagSnapshot {
  export type AsObject = {
    ...
    dnclListList: Array<wfo_vanalytics_v2_dncl_list_pb.DnclList.AsObject>,
  }
