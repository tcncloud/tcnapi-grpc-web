...
goog.exportSymbol('annotations.PermissionSet', null, proto);
goog.exportSymbol('annotations.Permissions', null, proto);
goog.exportSymbol('annotations.Taint', null, proto);
goog.exportSymbol('annotations.authz', null, proto);
/**
 ...
 * @constructor
 */
proto.annotations.Taint = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.annotations.Taint, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.annotations.Taint.displayName = 'proto.annotations.Taint';
}
...
proto.annotations.PermissionSet.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.annotations.Taint;
      reader.readMessage(value,proto.annotations.Taint.deserializeBinaryFromReader);
      msg.setTaint(value);
      break;
    default:
      reader.skipField();
...
proto.annotations.PermissionSet.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.annotations.Taint.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.annotations.Taint}
 */
proto.annotations.PermissionSet.prototype.getTaint = function() {
  return /** @type{?proto.annotations.Taint} */ (
    jspb.Message.getWrapperField(this, proto.annotations.Taint, 2));
};


/**
 * @param {?proto.annotations.Taint|undefined} value
 * @return {!proto.annotations.PermissionSet} returns this
*/
proto.annotations.PermissionSet.prototype.setTaint = function(value) {
 ...
 * @return {!proto.annotations.PermissionSet} returns this
 */
proto.annotations.PermissionSet.prototype.clearTaint = function() {
  return this.setTaint(undefined);
};
 ...
 * @return {boolean}
 */
proto.annotations.PermissionSet.prototype.hasTaint = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.annotations.Taint.prototype.toObject = function(opt_includeInstance) {
  return proto.annotations.Taint.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.annotations.Taint} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!proto.annotations.Taint}
 */
proto.annotations.Taint.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.annotations.Taint;
  return proto.annotations.Taint.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.annotations.Taint} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.annotations.Taint}
 */
proto.annotations.Taint.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.annotations.Taint.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.annotations.Taint.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.annotations.Taint} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.annotations.Taint.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * @param {number} value
 * @return {!proto.annotations.Taint} returns this
 */
proto.annotations.Taint.prototype.setId = function(value) {
  return jspb.Message.setField(this, 1, value);
};
 ...
 * @return {!proto.annotations.Taint} returns this
 */
proto.annotations.Taint.prototype.clearId = function() {
 ...
 * @return {boolean}
 */
proto.annotations.Taint.prototype.hasId = function() {
 ...
 * @return {!proto.annotations.Taint} returns this
 */
proto.annotations.Taint.prototype.setValue = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.annotations.Taint} returns this
 */
proto.annotations.Taint.prototype.clearValue = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.annotations.Taint.prototype.hasValue = function() {
  return jspb.Message.getField(this, 2) != null;
};
