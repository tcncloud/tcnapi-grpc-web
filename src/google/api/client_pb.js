...
goog.exportSymbol('google.api.ClientLibraryDestination', null, proto);
goog.exportSymbol('google.api.ClientLibraryOrganization', null, proto);
goog.exportSymbol('google.api.ClientLibrarySettings', null, proto);
goog.exportSymbol('google.api.CommonLanguageSettings', null, proto);
goog.exportSymbol('google.api.CppSettings', null, proto);
goog.exportSymbol('google.api.DotnetSettings', null, proto);
goog.exportSymbol('google.api.GoSettings', null, proto);
goog.exportSymbol('google.api.JavaSettings', null, proto);
goog.exportSymbol('google.api.MethodSettings', null, proto);
goog.exportSymbol('google.api.MethodSettings.LongRunning', null, proto);
goog.exportSymbol('google.api.NodeSettings', null, proto);
goog.exportSymbol('google.api.PhpSettings', null, proto);
goog.exportSymbol('google.api.Publishing', null, proto);
goog.exportSymbol('google.api.PythonSettings', null, proto);
goog.exportSymbol('google.api.RubySettings', null, proto);
goog.exportSymbol('google.api.apiVersion', null, proto);
goog.exportSymbol('google.api.defaultHost', null, proto);
goog.exportSymbol('google.api.methodSignatureList', null, proto);
goog.exportSymbol('google.api.oauthScopes', null, proto);
/**
