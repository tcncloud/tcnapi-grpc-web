...
export class CreateSkuRequest extends jspb.Message {
  ...
  hasSku(): boolean;
  clearSku(): void;
  getSku(): services_billing_entities_v1alpha3_sku_pb.Sku | undefined;
  setSku(value?: services_billing_entities_v1alpha3_sku_pb.Sku): void;
...
export namespace CreateSkuRequest {
  export type AsObject = {
    skuId: string,
    sku?: services_billing_entities_v1alpha3_sku_pb.Sku.AsObject,
  }
}
...
export class ListSkusResponse extends jspb.Message {
  clearSkusList(): void;
  getSkusList(): Array<services_billing_entities_v1alpha3_sku_pb.Sku>;
  setSkusList(value: Array<services_billing_entities_v1alpha3_sku_pb.Sku>): void;
  addSkus(value?: services_billing_entities_v1alpha3_sku_pb.Sku, index?: number): services_billing_entities_v1alpha3_sku_pb.Sku;
...
export namespace ListSkusResponse {
  export type AsObject = {
    skusList: Array<services_billing_entities_v1alpha3_sku_pb.Sku.AsObject>,
    token: string,
  }
}
