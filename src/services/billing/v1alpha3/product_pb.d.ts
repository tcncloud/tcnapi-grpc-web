...
// file: services/billing/v1alpha3/product.proto
...
export class ListProductsResponse extends jspb.Message {
  ...
  getProductsList(): Array<services_billing_entities_v1alpha3_rates_pb.Product>;
  setProductsList(value: Array<services_billing_entities_v1alpha3_rates_pb.Product>): void;
  addProducts(value?: services_billing_entities_v1alpha3_rates_pb.Product, index?: number): services_billing_entities_v1alpha3_rates_pb.Product;
...
export namespace ListProductsResponse {
  export type AsObject = {
    productsList: Array<services_billing_entities_v1alpha3_rates_pb.Product.AsObject>,
  }
}
