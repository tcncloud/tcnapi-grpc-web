...
goog.exportSymbol('proto.services.pbx.v2.GetSIPSessionPasswordRequest', null, global);
goog.exportSymbol('proto.services.pbx.v2.GetSIPSessionPasswordResponse', null, global);
 ...
 * @constructor
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.pbx.v2.GetSIPSessionPasswordRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.pbx.v2.GetSIPSessionPasswordRequest.displayName = 'proto.services.pbx.v2.GetSIPSessionPasswordRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.pbx.v2.GetSIPSessionPasswordResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.pbx.v2.GetSIPSessionPasswordResponse.displayName = 'proto.services.pbx.v2.GetSIPSessionPasswordResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.pbx.v2.GetSIPSessionPasswordRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.pbx.v2.GetSIPSessionPasswordRequest}
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.pbx.v2.GetSIPSessionPasswordRequest;
  return proto.services.pbx.v2.GetSIPSessionPasswordRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.pbx.v2.GetSIPSessionPasswordRequest}
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.pbx.v2.GetSIPSessionPasswordRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSIPSessionPasswordRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.pbx.v2.GetSIPSessionPasswordResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.pbx.v2.GetSIPSessionPasswordResponse}
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.pbx.v2.GetSIPSessionPasswordResponse;
  return proto.services.pbx.v2.GetSIPSessionPasswordResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.pbx.v2.GetSIPSessionPasswordResponse}
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.pbx.v2.GetSIPSessionPasswordResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.pbx.v2.GetSIPSessionPasswordResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.prototype.getPassword = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.pbx.v2.GetSIPSessionPasswordResponse} returns this
 */
proto.services.pbx.v2.GetSIPSessionPasswordResponse.prototype.setPassword = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
