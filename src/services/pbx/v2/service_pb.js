...
goog.exportSymbol('proto.services.pbx.v2.GetSipCredentialsRequest', null, global);
goog.exportSymbol('proto.services.pbx.v2.GetSipCredentialsResponse', null, global);
 ...
 * @constructor
 */
proto.services.pbx.v2.GetSipCredentialsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.pbx.v2.GetSipCredentialsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.pbx.v2.GetSipCredentialsRequest.displayName = 'proto.services.pbx.v2.GetSipCredentialsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.pbx.v2.GetSipCredentialsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.pbx.v2.GetSipCredentialsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.pbx.v2.GetSipCredentialsResponse.displayName = 'proto.services.pbx.v2.GetSipCredentialsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.services.pbx.v2.GetSipCredentialsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.pbx.v2.GetSipCredentialsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.pbx.v2.GetSipCredentialsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSipCredentialsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.pbx.v2.GetSipCredentialsRequest}
 */
proto.services.pbx.v2.GetSipCredentialsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.pbx.v2.GetSipCredentialsRequest;
  return proto.services.pbx.v2.GetSipCredentialsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.pbx.v2.GetSipCredentialsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.pbx.v2.GetSipCredentialsRequest}
 */
proto.services.pbx.v2.GetSipCredentialsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.pbx.v2.GetSipCredentialsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.pbx.v2.GetSipCredentialsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.pbx.v2.GetSipCredentialsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSipCredentialsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.pbx.v2.GetSipCredentialsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.pbx.v2.GetSipCredentialsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSipCredentialsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
sipDomain: jspb.Message.getFieldWithDefault(msg, 1, ""),
userUri: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.pbx.v2.GetSipCredentialsResponse}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.pbx.v2.GetSipCredentialsResponse;
  return proto.services.pbx.v2.GetSipCredentialsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.pbx.v2.GetSipCredentialsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.pbx.v2.GetSipCredentialsResponse}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setSipDomain(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setUserUri(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.pbx.v2.GetSipCredentialsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.pbx.v2.GetSipCredentialsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.pbx.v2.GetSipCredentialsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSipDomain();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string sip_domain = 1;
 * @return {string}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.getSipDomain = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.pbx.v2.GetSipCredentialsResponse} returns this
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.setSipDomain = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string user_uri = 2;
 * @return {string}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.getUserUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.services.pbx.v2.GetSipCredentialsResponse} returns this
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.setUserUri = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.getSessionToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.services.pbx.v2.GetSipCredentialsResponse} returns this
 */
proto.services.pbx.v2.GetSipCredentialsResponse.prototype.setSessionToken = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
