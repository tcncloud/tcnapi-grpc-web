...
type PBXServiceGetSipCredentials = {
  readonly methodName: string;
  readonly service: typeof PBXService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof services_pbx_v2_service_pb.GetSipCredentialsRequest;
  readonly responseType: typeof services_pbx_v2_service_pb.GetSipCredentialsResponse;
};
...
export class PBXService {
  ...
  static readonly GetSipCredentials: PBXServiceGetSipCredentials;
...
export class PBXServiceClient {
  ...
  getSipCredentials(
    requestMessage: services_pbx_v2_service_pb.GetSipCredentialsRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: services_pbx_v2_service_pb.GetSipCredentialsResponse|null) => void
  ): UnaryResponse;
  getSipCredentials(
    requestMessage: services_pbx_v2_service_pb.GetSipCredentialsRequest,
    callback: (error: ServiceError|null, responseMessage: services_pbx_v2_service_pb.GetSipCredentialsResponse|null) => void
