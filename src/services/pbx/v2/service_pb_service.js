...
PBXService.GetSipCredentials = {
  methodName: "GetSipCredentials",
  service: PBXService,
  requestStream: false,
  responseStream: false,
  requestType: services_pbx_v2_service_pb.GetSipCredentialsRequest,
  responseType: services_pbx_v2_service_pb.GetSipCredentialsResponse
};
...
PBXServiceClient.prototype.getSipCredentials = function getSipCredentials(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(PBXService.GetSipCredentials, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
