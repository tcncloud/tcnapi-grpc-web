...
goog.exportSymbol('proto.services.org.exile_certificate_manager.v1.ConfigurationInfo', null, global);
goog.exportSymbol('proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType', null, global);
/**
 ...
 * @constructor
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.org.exile_certificate_manager.v1.ConfigurationInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.displayName = 'proto.services.org.exile_certificate_manager.v1.ConfigurationInfo';
}
 ...
 * @return {!Object}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.org.exile_certificate_manager.v1.ConfigurationInfo;
  return proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 4:
      ...
      break;
    case 5:
      var value = /** @type {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 6:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getConfigurationInfoId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getConfigurationInfoId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setConfigurationInfoId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getOrgId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setOrgId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setDescription = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getType = function() {
  return /** @type {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/**
 * @param {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType} value
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setType = function(value) {
 ...
 * @return {string}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.getParameters = function() {
 ...
 * @return {!proto.services.org.exile_certificate_manager.v1.ConfigurationInfo} returns this
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfo.prototype.setParameters = function(value) {
 ...
 * @enum {number}
 */
proto.services.org.exile_certificate_manager.v1.ConfigurationInfoType = {
