...
HuntGroupsService.ListAgentCampaignClientInfoDisplayTemplates = {
  methodName: "ListAgentCampaignClientInfoDisplayTemplates",
  service: HuntGroupsService,
  requestStream: false,
  responseStream: true,
  requestType: services_org_hunt_groups_v1alpha1_entities_pb.ListAgentClientInfoDisplayTemplatesRequest,
...
HuntGroupsServiceClient.prototype.listAgentCampaignClientInfoDisplayTemplates = function listAgentCampaignClientInfoDisplayTemplates(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(HuntGroupsService.ListAgentCampaignClientInfoDisplayTemplates, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
