...
export class RetypeCollectionReq extends jspb.Message {
  ...
  getFieldTypesMap(): jspb.Map<string, api_commons_lms_pb.FieldType[keyof api_commons_lms_pb.FieldType]>;
  clearFieldTypesMap(): void;
  getAsCopy(): boolean;
  setAsCopy(value: boolean): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RetypeCollectionReq.AsObject;
  static toObject(includeInstance: boolean, msg: RetypeCollectionReq): RetypeCollectionReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RetypeCollectionReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RetypeCollectionReq;
  static deserializeBinaryFromReader(message: RetypeCollectionReq, reader: jspb.BinaryReader): RetypeCollectionReq;
}

export namespace RetypeCollectionReq {
  export type AsObject = {
    collectionId: string,
    primaryKeyList: Array<string>,
    fieldTypesMap: Array<[string, api_commons_lms_pb.FieldType[keyof api_commons_lms_pb.FieldType]]>,
    asCopy: boolean,
  }
}

export class RetypeCollectionRes extends jspb.Message {
  getCollectionId(): string;
  setCollectionId(value: string): void;

  getInsertedCount(): number;
  setInsertedCount(value: number): void;

  getUpdatedCount(): number;
  setUpdatedCount(value: number): void;

  getRejectedCount(): number;
  setRejectedCount(value: number): void;

  getIgnoredCount(): number;
  setIgnoredCount(value: number): void;

  clearRejectedEntryIdsList(): void;
  getRejectedEntryIdsList(): Array<string>;
  setRejectedEntryIdsList(value: Array<string>): void;
  addRejectedEntryIds(value: string, index?: number): string;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RetypeCollectionRes.AsObject;
  static toObject(includeInstance: boolean, msg: RetypeCollectionRes): RetypeCollectionRes.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RetypeCollectionRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RetypeCollectionRes;
  static deserializeBinaryFromReader(message: RetypeCollectionRes, reader: jspb.BinaryReader): RetypeCollectionRes;
}

export namespace RetypeCollectionRes {
  export type AsObject = {
    collectionId: string,
    ...
    ignoredCount: number,
    rejectedEntryIdsList: Array<string>,
  }
}
