...
export class GetUpdateUrlReq extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetUpdateUrlReq.AsObject;
  static toObject(includeInstance: boolean, msg: GetUpdateUrlReq): GetUpdateUrlReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetUpdateUrlReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetUpdateUrlReq;
  static deserializeBinaryFromReader(message: GetUpdateUrlReq, reader: jspb.BinaryReader): GetUpdateUrlReq;
}

export namespace GetUpdateUrlReq {
  export type AsObject = {
  }
}

export class GetUpdateUrlRes extends jspb.Message {
  getUrl(): string;
  setUrl(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetUpdateUrlRes.AsObject;
  static toObject(includeInstance: boolean, msg: GetUpdateUrlRes): GetUpdateUrlRes.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetUpdateUrlRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetUpdateUrlRes;
  static deserializeBinaryFromReader(message: GetUpdateUrlRes, reader: jspb.BinaryReader): GetUpdateUrlRes;
}

export namespace GetUpdateUrlRes {
  export type AsObject = {
    url: string,
    id: string,
  }
