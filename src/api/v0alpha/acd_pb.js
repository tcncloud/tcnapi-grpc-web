...
goog.exportSymbol('proto.api.v0alpha.AgentVoiceStatusDetails', null, global);
...
goog.exportSymbol('proto.api.v0alpha.ListAgentsVoiceStatusesReply', null, global);
goog.exportSymbol('proto.api.v0alpha.ListAgentsVoiceStatusesRequest', null, global);
 ...
 * @constructor
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v0alpha.ListAgentsVoiceStatusesRequest.repeatedFields_, null);
};
goog.inherits(proto.api.v0alpha.ListAgentsVoiceStatusesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.ListAgentsVoiceStatusesRequest.displayName = 'proto.api.v0alpha.ListAgentsVoiceStatusesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v0alpha.ListAgentsVoiceStatusesReply.repeatedFields_, null);
};
goog.inherits(proto.api.v0alpha.ListAgentsVoiceStatusesReply, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.ListAgentsVoiceStatusesReply.displayName = 'proto.api.v0alpha.ListAgentsVoiceStatusesReply';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v0alpha.AgentVoiceStatusDetails = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v0alpha.AgentVoiceStatusDetails.repeatedFields_, null);
};
goog.inherits(proto.api.v0alpha.AgentVoiceStatusDetails, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.AgentVoiceStatusDetails.displayName = 'proto.api.v0alpha.AgentVoiceStatusDetails';
}
 ...
 * @const
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.ListAgentsVoiceStatusesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
skillsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
allSkillsRequired: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.ListAgentsVoiceStatusesRequest;
  return proto.api.v0alpha.ListAgentsVoiceStatusesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.ListAgentsVoiceStatusesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSkillsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array<string>}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.getSkillsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.setSkillsList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.addSkills = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.clearSkillsList = function() {
  return this.setSkillsList([]);
};


/**
 * optional bool all_skills_required = 2;
 * @return {boolean}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.getAllSkillsRequired = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.setAllSkillsRequired = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.getPageToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesRequest} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesRequest.prototype.setPageToken = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @const
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.ListAgentsVoiceStatusesReply.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.toObject = function(includeInstance, msg) {
  var f, obj = {
agentDetailsList: jspb.Message.toObjectList(msg.getAgentDetailsList(),
    proto.api.v0alpha.AgentVoiceStatusDetails.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesReply}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.ListAgentsVoiceStatusesReply;
  return proto.api.v0alpha.ListAgentsVoiceStatusesReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesReply}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.v0alpha.AgentVoiceStatusDetails;
      reader.readMessage(value,proto.api.v0alpha.AgentVoiceStatusDetails.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.ListAgentsVoiceStatusesReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.v0alpha.AgentVoiceStatusDetails.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.api.v0alpha.AgentVoiceStatusDetails>}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.getAgentDetailsList = function() {
  return /** @type{!Array<!proto.api.v0alpha.AgentVoiceStatusDetails>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.v0alpha.AgentVoiceStatusDetails, 1));
};


/**
 * @param {!Array<!proto.api.v0alpha.AgentVoiceStatusDetails>} value
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} returns this
*/
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.setAgentDetailsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.v0alpha.AgentVoiceStatusDetails=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.addAgentDetails = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.v0alpha.AgentVoiceStatusDetails, opt_index);
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.clearAgentDetailsList = function() {
 ...
 * @return {string}
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.getNextPageToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.v0alpha.ListAgentsVoiceStatusesReply} returns this
 */
proto.api.v0alpha.ListAgentsVoiceStatusesReply.prototype.setNextPageToken = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.AgentVoiceStatusDetails.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.AgentVoiceStatusDetails} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.AgentVoiceStatusDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
agentSid: jspb.Message.getFieldWithDefault(msg, 1, 0),
huntGroupSid: jspb.Message.getFieldWithDefault(msg, 2, 0),
currentSessionSid: jspb.Message.getFieldWithDefault(msg, 3, 0),
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.AgentVoiceStatusDetails;
  return proto.api.v0alpha.AgentVoiceStatusDetails.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.AgentVoiceStatusDetails} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      var value = /** @type {number} */ (reader.readInt64());
      msg.setCurrentSessionSid(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.AgentVoiceStatusDetails.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.AgentVoiceStatusDetails} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.AgentVoiceStatusDetails.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAgentSid();
  if (f !== 0) {
    writer.writeInt64(
  ...
  f = message.getCurrentSessionSid();
  if (f !== 0) {
    writer.writeInt64(
      3,
      f
 ...
 * @return {number}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getAgentSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setAgentSid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getHuntGroupSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setHuntGroupSid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional int64 current_session_sid = 3;
 * @return {number}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getCurrentSessionSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setCurrentSessionSid = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getFirstName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setFirstName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getLastName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setLastName = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getStatus = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setStatus = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};


/**
 * optional api.commons.AgentStatus.Enum status_desc = 7;
 * @return {!proto.api.commons.AgentStatus.Enum}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getStatusDesc = function() {
  return /** @type {!proto.api.commons.AgentStatus.Enum} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setStatusDesc = function(value) {
 ...
 * @return {!Array<string>}
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.getSkillsList = function() {
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.setSkillsList = function(value) {
 ...
 * @return {!proto.api.v0alpha.AgentVoiceStatusDetails} returns this
 */
proto.api.v0alpha.AgentVoiceStatusDetails.prototype.addSkills = function(value, opt_index) {
