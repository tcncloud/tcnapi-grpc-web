...
export class GetMailMergeReq extends jspb.Message {
  getClientSid(): number;
  setClientSid(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetMailMergeReq.AsObject;
  static toObject(includeInstance: boolean, msg: GetMailMergeReq): GetMailMergeReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetMailMergeReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetMailMergeReq;
  static deserializeBinaryFromReader(message: GetMailMergeReq, reader: jspb.BinaryReader): GetMailMergeReq;
}

export namespace GetMailMergeReq {
  export type AsObject = {
    clientSid: number,
    agentSid: number,
    data?: MailMergeData.AsObject,
...
export class GetMailMergeRes extends jspb.Message {
  getAgentInfoMap(): jspb.Map<string, string>;
  clearAgentInfoMap(): void;
  getCustomDataMap(): jspb.Map<string, string>;
  clearCustomDataMap(): void;
  getDataCollectMap(): jspb.Map<string, string>;
  clearDataCollectMap(): void;
  getDataDipMap(): jspb.Map<string, string>;
  clearDataDipMap(): void;
  getIvrMap(): jspb.Map<string, string>;
  clearIvrMap(): void;
  getScheduledCallMap(): jspb.Map<string, string>;
  clearScheduledCallMap(): void;
  getTtsMap(): jspb.Map<string, string>;
  clearTtsMap(): void;
  getZipPhoneMetadataMap(): jspb.Map<string, string>;
  clearZipPhoneMetadataMap(): void;
  getJourneyRetrievedDataMap(): jspb.Map<string, string>;
  clearJourneyRetrievedDataMap(): void;
  getIntegrationDataMap(): jspb.Map<string, string>;
  clearIntegrationDataMap(): void;
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetMailMergeRes.AsObject;
  static toObject(includeInstance: boolean, msg: GetMailMergeRes): GetMailMergeRes.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetMailMergeRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetMailMergeRes;
  static deserializeBinaryFromReader(message: GetMailMergeRes, reader: jspb.BinaryReader): GetMailMergeRes;
}

export namespace GetMailMergeRes {
  export type AsObject = {
    agentInfoMap: Array<[string, string]>,
    customDataMap: Array<[string, string]>,
    dataCollectMap: Array<[string, string]>,
    dataDipMap: Array<[string, string]>,
    ivrMap: Array<[string, string]>,
    scheduledCallMap: Array<[string, string]>,
    ttsMap: Array<[string, string]>,
    zipPhoneMetadataMap: Array<[string, string]>,
    journeyRetrievedDataMap: Array<[string, string]>,
    integrationDataMap: Array<[string, string]>,
  }
}
