...
var P3Api = (function () {
  function P3Api() {}
  P3Api.serviceName = "api.v0alpha.P3Api";
  return P3Api;
}());
...
P3Api.ListAgentSkills = {
  methodName: "ListAgentSkills",
  service: P3Api,
  requestStream: false,
  responseStream: false,
  requestType: api_v0alpha_p3api_pb.ListAgentSkillsReq,
  responseType: api_v0alpha_p3api_pb.ListAgentSkillsRes
};
...
P3Api.ListExtendedCallHistory = {
  methodName: "ListExtendedCallHistory",
  service: P3Api,
  requestStream: false,
  responseStream: true,
...
P3Api.GetActivityLogHistory = {
  methodName: "GetActivityLogHistory",
  service: P3Api,
  requestStream: false,
  responseStream: true,
...
P3Api.ListDistinctPauseCodes = {
  methodName: "ListDistinctPauseCodes",
  service: P3Api,
  requestStream: false,
  responseStream: false,
  requestType: api_v0alpha_p3api_pb.ListDistinctPauseCodesRequest,
  responseType: api_v0alpha_p3api_pb.ListDistinctPauseCodesResponse
};
...
P3ApiClient.prototype.listAgentSkills = function listAgentSkills(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(P3Api.ListAgentSkills, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
P3ApiClient.prototype.listExtendedCallHistory = function listExtendedCallHistory(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(P3Api.ListExtendedCallHistory, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
P3ApiClient.prototype.getActivityLogHistory = function getActivityLogHistory(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(P3Api.GetActivityLogHistory, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
P3ApiClient.prototype.listDistinctPauseCodes = function listDistinctPauseCodes(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(P3Api.ListDistinctPauseCodes, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
