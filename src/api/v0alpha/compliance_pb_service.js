...
Compliance.DeleteAllListEntries = {
  methodName: "DeleteAllListEntries",
  service: Compliance,
  requestStream: false,
  responseStream: false,
  requestType: api_v0alpha_compliance_pb.DeleteAllListEntriesRequest,
  responseType: api_v0alpha_compliance_pb.DeleteAllListEntriesResponse
};
...
ComplianceClient.prototype.deleteAllListEntries = function deleteAllListEntries(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Compliance.DeleteAllListEntries, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
