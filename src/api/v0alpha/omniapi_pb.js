...
goog.exportSymbol('proto.api.v0alpha.CreateWhatsAppNumberReq', null, global);
goog.exportSymbol('proto.api.v0alpha.CreateWhatsAppNumberRes', null, global);
...
goog.exportSymbol('proto.api.v0alpha.UpdateWhatsAppNumberReq', null, global);
goog.exportSymbol('proto.api.v0alpha.UpdateWhatsAppNumberRes', null, global);
/**
 ...
 * @constructor
 */
proto.api.v0alpha.CreateWhatsAppNumberReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v0alpha.CreateWhatsAppNumberReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.CreateWhatsAppNumberReq.displayName = 'proto.api.v0alpha.CreateWhatsAppNumberReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v0alpha.CreateWhatsAppNumberRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v0alpha.CreateWhatsAppNumberRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.CreateWhatsAppNumberRes.displayName = 'proto.api.v0alpha.CreateWhatsAppNumberRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v0alpha.UpdateWhatsAppNumberReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.UpdateWhatsAppNumberReq.displayName = 'proto.api.v0alpha.UpdateWhatsAppNumberReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v0alpha.UpdateWhatsAppNumberRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v0alpha.UpdateWhatsAppNumberRes.displayName = 'proto.api.v0alpha.UpdateWhatsAppNumberRes';
}
 ...
 * @const
 */
proto.api.v0alpha.ListCampaignsReq.oneofGroups_ = [[100,101,102,103,104,105,106,107,108]];
 ...
 * @const
 */
proto.api.v0alpha.ListConversationsReq.oneofGroups_ = [[100,101]];
 ...
 * @const
 */
proto.api.v0alpha.HeaderGroup.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.CreateWhatsAppNumberReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberReq}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.CreateWhatsAppNumberReq;
  return proto.api.v0alpha.CreateWhatsAppNumberReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberReq}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.CreateWhatsAppNumberReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {?proto.api.commons.WhatsAppNumber}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.getWhatsappNumber = function() {
 ...
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberReq} returns this
*/
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.setWhatsappNumber = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberReq} returns this
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.clearWhatsappNumber = function() {
 ...
 * @return {boolean}
 */
proto.api.v0alpha.CreateWhatsAppNumberReq.prototype.hasWhatsappNumber = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.CreateWhatsAppNumberRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    whatsappNumber: (f = msg.getWhatsappNumber()) && api_commons_omnichannel_pb.WhatsAppNumber.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberRes}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.CreateWhatsAppNumberRes;
  return proto.api.v0alpha.CreateWhatsAppNumberRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberRes}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.CreateWhatsAppNumberRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.CreateWhatsAppNumberRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWhatsappNumber();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.commons.WhatsAppNumber}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.getWhatsappNumber = function() {
  return /** @type{?proto.api.commons.WhatsAppNumber} */ (
    jspb.Message.getWrapperField(this, api_commons_omnichannel_pb.WhatsAppNumber, 1));
};
...
/**
 * @param {?proto.api.commons.WhatsAppNumber|undefined} value
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberRes} returns this
*/
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.setWhatsappNumber = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v0alpha.CreateWhatsAppNumberRes} returns this
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.clearWhatsappNumber = function() {
  return this.setWhatsappNumber(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v0alpha.CreateWhatsAppNumberRes.prototype.hasWhatsappNumber = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.UpdateWhatsAppNumberReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    whatsappNumber: (f = msg.getWhatsappNumber()) && api_commons_omnichannel_pb.WhatsAppNumber.toObject(includeInstance, f),
    fieldMask: (f = msg.getFieldMask()) && google_protobuf_field_mask_pb.FieldMask.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.UpdateWhatsAppNumberReq;
  return proto.api.v0alpha.UpdateWhatsAppNumberReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.UpdateWhatsAppNumberReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWhatsappNumber();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.commons.WhatsAppNumber}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.getWhatsappNumber = function() {
  return /** @type{?proto.api.commons.WhatsAppNumber} */ (
    jspb.Message.getWrapperField(this, api_commons_omnichannel_pb.WhatsAppNumber, 1));
};
...
/**
 * @param {?proto.api.commons.WhatsAppNumber|undefined} value
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq} returns this
*/
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.setWhatsappNumber = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq} returns this
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.clearWhatsappNumber = function() {
  return this.setWhatsappNumber(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.hasWhatsappNumber = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.google.protobuf.FieldMask}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.getFieldMask = function() {
  return /** @type{?proto.google.protobuf.FieldMask} */ (
    jspb.Message.getWrapperField(this, google_protobuf_field_mask_pb.FieldMask, 100));
};
 ...
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq} returns this
*/
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.setFieldMask = function(value) {
  return jspb.Message.setWrapperField(this, 100, value);
};
 ...
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberReq} returns this
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.clearFieldMask = function() {
  return this.setFieldMask(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v0alpha.UpdateWhatsAppNumberReq.prototype.hasFieldMask = function() {
  return jspb.Message.getField(this, 100) != null;
};
 ...
 * @return {!Object}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v0alpha.UpdateWhatsAppNumberRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    whatsappNumber: (f = msg.getWhatsappNumber()) && api_commons_omnichannel_pb.WhatsAppNumber.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberRes}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v0alpha.UpdateWhatsAppNumberRes;
  return proto.api.v0alpha.UpdateWhatsAppNumberRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberRes}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v0alpha.UpdateWhatsAppNumberRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v0alpha.UpdateWhatsAppNumberRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWhatsappNumber();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.commons.WhatsAppNumber}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.getWhatsappNumber = function() {
  return /** @type{?proto.api.commons.WhatsAppNumber} */ (
    jspb.Message.getWrapperField(this, api_commons_omnichannel_pb.WhatsAppNumber, 1));
};
...
/**
 * @param {?proto.api.commons.WhatsAppNumber|undefined} value
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberRes} returns this
*/
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.setWhatsappNumber = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v0alpha.UpdateWhatsAppNumberRes} returns this
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.clearWhatsappNumber = function() {
  return this.setWhatsappNumber(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v0alpha.UpdateWhatsAppNumberRes.prototype.hasWhatsappNumber = function() {
  return jspb.Message.getField(this, 1) != null;
};
