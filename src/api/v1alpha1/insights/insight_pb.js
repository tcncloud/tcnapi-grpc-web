...
goog.exportSymbol('proto.api.v1alpha1.insights.CardVisualization', null, global);
...
goog.exportSymbol('proto.api.v1alpha1.insights.ExportOptions', null, global);
...
goog.exportSymbol('proto.api.v1alpha1.insights.TextValue', null, global);
goog.exportSymbol('proto.api.v1alpha1.insights.TextValueCondition', null, global);
goog.exportSymbol('proto.api.v1alpha1.insights.TextValueCondition.Color', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.ExportOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.insights.ExportOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.ExportOptions.displayName = 'proto.api.v1alpha1.insights.ExportOptions';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.CardVisualization = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.insights.CardVisualization.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.insights.CardVisualization, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.CardVisualization.displayName = 'proto.api.v1alpha1.insights.CardVisualization';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.TextValue = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.insights.TextValue.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.insights.TextValue, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.TextValue.displayName = 'proto.api.v1alpha1.insights.TextValue';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.TextValueCondition = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.insights.TextValueCondition.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.insights.TextValueCondition, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.TextValueCondition.displayName = 'proto.api.v1alpha1.insights.TextValueCondition';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.TextValueCondition.Color = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.insights.TextValueCondition.Color, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.TextValueCondition.Color.displayName = 'proto.api.v1alpha1.insights.TextValueCondition.Color';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
dataExportOptions: (f = msg.getDataExportOptions()) && api_v1alpha1_explorer_entities_pb.ExportOptions.toObject(includeInstance, f)
  };
...
proto.api.v1alpha1.insights.Insight.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 18:
      ...
      break;
    case 19:
      var value = new api_v1alpha1_explorer_entities_pb.ExportOptions;
      reader.readMessage(value,api_v1alpha1_explorer_entities_pb.ExportOptions.deserializeBinaryFromReader);
      msg.setDataExportOptions(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.api.v1alpha1.insights.Insight.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDataExportOptions();
  if (f != null) {
    writer.writeMessage(
      19,
      f,
      api_v1alpha1_explorer_entities_pb.ExportOptions.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Pipeline pipeline = 16;
 * @return {?proto.api.v1alpha1.insights.Pipeline}
 */
proto.api.v1alpha1.insights.Insight.prototype.getPipeline = function() {
  return /** @type{?proto.api.v1alpha1.insights.Pipeline} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_insights_insight_content_pb.Pipeline, 16));
};
 ...
 * @return {!proto.api.v1alpha1.insights.Insight} returns this
*/
proto.api.v1alpha1.insights.Insight.prototype.setPipeline = function(value) {
 ...
 * @return {!proto.api.v1alpha1.insights.Insight} returns this
 */
proto.api.v1alpha1.insights.Insight.prototype.clearPipeline = function() {
...
/**
 * optional api.v1alpha1.explorer.ExportOptions data_export_options = 19;
 * @return {?proto.api.v1alpha1.explorer.ExportOptions}
 */
proto.api.v1alpha1.insights.Insight.prototype.getDataExportOptions = function() {
  return /** @type{?proto.api.v1alpha1.explorer.ExportOptions} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_explorer_entities_pb.ExportOptions, 19));
};


/**
 * @param {?proto.api.v1alpha1.explorer.ExportOptions|undefined} value
 * @return {!proto.api.v1alpha1.insights.Insight} returns this
*/
proto.api.v1alpha1.insights.Insight.prototype.setDataExportOptions = function(value) {
 ...
 * @return {!proto.api.v1alpha1.insights.Insight} returns this
 */
proto.api.v1alpha1.insights.Insight.prototype.clearDataExportOptions = function() {
  return this.setDataExportOptions(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.insights.Insight.prototype.hasDataExportOptions = function() {
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.ExportOptions.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.ExportOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.ExportOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.v1alpha1.insights.ExportOptions}
 */
proto.api.v1alpha1.insights.ExportOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.ExportOptions;
  return proto.api.v1alpha1.insights.ExportOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.ExportOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.ExportOptions}
 */
proto.api.v1alpha1.insights.ExportOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.ExportOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.ExportOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.ExportOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.getDelimiter = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.insights.ExportOptions} returns this
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.setDelimiter = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.getQuoteCharacter = function() {
  return /** @type {!proto.api.v1alpha1.insights.QuoteCharacter} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.v1alpha1.insights.ExportOptions} returns this
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.setQuoteCharacter = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.getNoHeader = function() {
 ...
 * @return {!proto.api.v1alpha1.insights.ExportOptions} returns this
 */
proto.api.v1alpha1.insights.ExportOptions.prototype.setNoHeader = function(value) {
 ...
 * @const
 */
proto.api.v1alpha1.insights.CardVisualization.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.CardVisualization.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.CardVisualization.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.CardVisualization} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.CardVisualization.toObject = function(includeInstance, msg) {
  var f, obj = {
textValuesList: jspb.Message.toObjectList(msg.getTextValuesList(),
    proto.api.v1alpha1.insights.TextValue.toObject, includeInstance)
  };
 ...
 */
proto.api.v1alpha1.insights.CardVisualization.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.CardVisualization;
  return proto.api.v1alpha1.insights.CardVisualization.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.CardVisualization} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.CardVisualization}
 */
proto.api.v1alpha1.insights.CardVisualization.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.v1alpha1.insights.TextValue;
      reader.readMessage(value,proto.api.v1alpha1.insights.TextValue.deserializeBinaryFromReader);
      msg.addTextValues(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.CardVisualization.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.CardVisualization.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.CardVisualization} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.CardVisualization.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTextValuesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.v1alpha1.insights.TextValue.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.api.v1alpha1.insights.TextValue>}
 */
proto.api.v1alpha1.insights.CardVisualization.prototype.getTextValuesList = function() {
  return /** @type{!Array<!proto.api.v1alpha1.insights.TextValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.v1alpha1.insights.TextValue, 1));
};


/**
 * @param {!Array<!proto.api.v1alpha1.insights.TextValue>} value
 * @return {!proto.api.v1alpha1.insights.CardVisualization} returns this
*/
proto.api.v1alpha1.insights.CardVisualization.prototype.setTextValuesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.v1alpha1.insights.TextValue=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.v1alpha1.insights.TextValue}
 */
proto.api.v1alpha1.insights.CardVisualization.prototype.addTextValues = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.v1alpha1.insights.TextValue, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.insights.CardVisualization} returns this
 */
proto.api.v1alpha1.insights.CardVisualization.prototype.clearTextValuesList = function() {
  return this.setTextValuesList([]);
};
 ...
 * @const
 */
proto.api.v1alpha1.insights.TextValue.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.TextValue.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.TextValue.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.TextValue} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValue.toObject = function(includeInstance, msg) {
  var f, obj = {
conditionsList: jspb.Message.toObjectList(msg.getConditionsList(),
    proto.api.v1alpha1.insights.TextValueCondition.toObject, includeInstance)
  };
 ...
 * @return {!proto.api.v1alpha1.insights.TextValue}
 */
proto.api.v1alpha1.insights.TextValue.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.TextValue;
  return proto.api.v1alpha1.insights.TextValue.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.TextValue} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.TextValue}
 */
proto.api.v1alpha1.insights.TextValue.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.v1alpha1.insights.TextValueCondition;
      reader.readMessage(value,proto.api.v1alpha1.insights.TextValueCondition.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.TextValue.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.TextValue.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.TextValue} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValue.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.v1alpha1.insights.TextValueCondition.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.api.v1alpha1.insights.TextValueCondition>}
 */
proto.api.v1alpha1.insights.TextValue.prototype.getConditionsList = function() {
  return /** @type{!Array<!proto.api.v1alpha1.insights.TextValueCondition>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.v1alpha1.insights.TextValueCondition, 1));
};


/**
 * @param {!Array<!proto.api.v1alpha1.insights.TextValueCondition>} value
 * @return {!proto.api.v1alpha1.insights.TextValue} returns this
*/
proto.api.v1alpha1.insights.TextValue.prototype.setConditionsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.v1alpha1.insights.TextValueCondition=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.v1alpha1.insights.TextValueCondition}
 */
proto.api.v1alpha1.insights.TextValue.prototype.addConditions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.v1alpha1.insights.TextValueCondition, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValue} returns this
 */
proto.api.v1alpha1.insights.TextValue.prototype.clearConditionsList = function() {
 ...
 * @const
 */
proto.api.v1alpha1.insights.TextValueCondition.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.TextValueCondition.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.TextValueCondition} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValueCondition.toObject = function(includeInstance, msg) {
  var f, obj = {
expression: (f = msg.getExpression()) && api_v1alpha1_insights_insight_content_pb.ExpressionNode.toObject(includeInstance, f),
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition}
 */
proto.api.v1alpha1.insights.TextValueCondition.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.TextValueCondition;
  return proto.api.v1alpha1.insights.TextValueCondition.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.TextValueCondition} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.TextValueCondition}
 */
proto.api.v1alpha1.insights.TextValueCondition.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new api_v1alpha1_insights_insight_content_pb.ExpressionNode;
      reader.readMessage(value,api_v1alpha1_insights_insight_content_pb.ExpressionNode.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.TextValueCondition.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.TextValueCondition} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValueCondition.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      api_v1alpha1_insights_insight_content_pb.ExpressionNode.serializeBinaryToWriter
    );
  }
  f = message.getSize();
  if (f !== 0) {
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.TextValueCondition.Color.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.TextValueCondition.Color} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.insights.TextValueCondition.Color}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.TextValueCondition.Color;
  return proto.api.v1alpha1.insights.TextValueCondition.Color.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.TextValueCondition.Color} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.TextValueCondition.Color}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.TextValueCondition.Color.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.TextValueCondition.Color} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRed();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.getRed = function() {
...
/**
 * @param {number} value
 * @return {!proto.api.v1alpha1.insights.TextValueCondition.Color} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.setRed = function(value) {
 ...
 * @return {number}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.getGreen = function() {
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition.Color} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.setGreen = function(value) {
 ...
 * @return {number}
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.getBlue = function() {
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition.Color} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.Color.prototype.setBlue = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};


/**
 * optional ExpressionNode expression = 1;
 * @return {?proto.api.v1alpha1.insights.ExpressionNode}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.getExpression = function() {
  return /** @type{?proto.api.v1alpha1.insights.ExpressionNode} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_insights_insight_content_pb.ExpressionNode, 1));
};
...
*/
proto.api.v1alpha1.insights.TextValueCondition.prototype.setExpression = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.clearExpression = function() {
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.hasExpression = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.getSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.setSize = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.getOperationsList = function() {
  return /** @type{!Array<!proto.api.v1alpha1.insights.ColumnOperation>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.v1alpha1.insights.ColumnOperation, 3));
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
*/
proto.api.v1alpha1.insights.TextValueCondition.prototype.setOperationsList = function(value) {
 ...
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.addOperations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.api.v1alpha1.insights.ColumnOperation, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.clearOperationsList = function() {
 ...
 * @return {string}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.getIconName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.setIconName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional Color icon_color = 5;
 * @return {?proto.api.v1alpha1.insights.TextValueCondition.Color}
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.getIconColor = function() {
  return /** @type{?proto.api.v1alpha1.insights.TextValueCondition.Color} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.insights.TextValueCondition.Color, 5));
};


/**
 * @param {?proto.api.v1alpha1.insights.TextValueCondition.Color|undefined} value
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
*/
proto.api.v1alpha1.insights.TextValueCondition.prototype.setIconColor = function(value) {
 ...
 * @return {!proto.api.v1alpha1.insights.TextValueCondition} returns this
 */
proto.api.v1alpha1.insights.TextValueCondition.prototype.clearIconColor = function() {
  return this.setIconColor(undefined);
};
