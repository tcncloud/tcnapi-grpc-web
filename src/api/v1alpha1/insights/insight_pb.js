...
contextualAction: jspb.Message.getFieldWithDefault(msg, 9, 0)
  };
...
/**
 * optional ContextualActionType contextual_action = 9;
...
proto.api.v1alpha1.insights.TableColumnConfig.prototype.getContextualAction = function() {
  return /** @type {!proto.api.v1alpha1.insights.ContextualActionType} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};
