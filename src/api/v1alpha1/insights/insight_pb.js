...
goog.exportSymbol('proto.api.v1alpha1.insights.FixedWidthVisualization', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.insights.FixedWidthVisualization = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.insights.FixedWidthVisualization.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.insights.FixedWidthVisualization, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.insights.FixedWidthVisualization.displayName = 'proto.api.v1alpha1.insights.FixedWidthVisualization';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.insights.FixedWidthVisualization.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.insights.FixedWidthVisualization} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.insights.FixedWidthVisualization}
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.insights.FixedWidthVisualization;
  return proto.api.v1alpha1.insights.FixedWidthVisualization.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.insights.FixedWidthVisualization} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.insights.FixedWidthVisualization}
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.insights.FixedWidthVisualization.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.insights.FixedWidthVisualization} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!proto.api.v1alpha1.insights.FixedWidthVisualization} returns this
 */
proto.api.v1alpha1.insights.FixedWidthVisualization.prototype.clearTableColumnDetailsList = function() {
