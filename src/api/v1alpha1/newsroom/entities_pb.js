...
goog.exportSymbol('proto.api.v1alpha1.newsroom.NewsroomImage', null, global);
goog.exportSymbol('proto.api.v1alpha1.newsroom.PublishedArticleDetails', null, global);
goog.exportSymbol('proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest', null, global);
goog.exportSymbol('proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.displayName = 'proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.newsroom.NewsroomImage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.newsroom.NewsroomImage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.newsroom.NewsroomImage.displayName = 'proto.api.v1alpha1.newsroom.NewsroomImage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.displayName = 'proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse';
}
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    image: (f = msg.getImage()) && proto.api.v1alpha1.newsroom.NewsroomImage.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest;
  return proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.v1alpha1.newsroom.NewsroomImage;
      reader.readMessage(value,proto.api.v1alpha1.newsroom.NewsroomImage.deserializeBinaryFromReader);
      msg.setImage(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getImage();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.api.v1alpha1.newsroom.NewsroomImage.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional NewsroomImage image = 1;
 * @return {?proto.api.v1alpha1.newsroom.NewsroomImage}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.getImage = function() {
  return /** @type{?proto.api.v1alpha1.newsroom.NewsroomImage} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.newsroom.NewsroomImage, 1));
};


/**
 * @param {?proto.api.v1alpha1.newsroom.NewsroomImage|undefined} value
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest} returns this
*/
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.setImage = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest} returns this
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.clearImage = function() {
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageRequest.prototype.hasImage = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.newsroom.NewsroomImage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.newsroom.NewsroomImage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.NewsroomImage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.v1alpha1.newsroom.NewsroomImage}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.newsroom.NewsroomImage;
  return proto.api.v1alpha1.newsroom.NewsroomImage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.newsroom.NewsroomImage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.newsroom.NewsroomImage}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.newsroom.NewsroomImage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.newsroom.NewsroomImage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.NewsroomImage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUuid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.getUuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.newsroom.NewsroomImage} returns this
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.setUuid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.getContent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.v1alpha1.newsroom.NewsroomImage} returns this
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.setContent = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.getDownloadUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.v1alpha1.newsroom.NewsroomImage} returns this
 */
proto.api.v1alpha1.newsroom.NewsroomImage.prototype.setDownloadUrl = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    image: (f = msg.getImage()) && proto.api.v1alpha1.newsroom.NewsroomImage.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse;
  return proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getImage();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.v1alpha1.newsroom.NewsroomImage}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.getImage = function() {
  return /** @type{?proto.api.v1alpha1.newsroom.NewsroomImage} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.newsroom.NewsroomImage, 1));
};
...
/**
 * @param {?proto.api.v1alpha1.newsroom.NewsroomImage|undefined} value
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse} returns this
*/
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.setImage = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse} returns this
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.clearImage = function() {
  return this.setImage(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.newsroom.StoreNewsroomImageResponse.prototype.hasImage = function() {
  return jspb.Message.getField(this, 1) != null;
};
