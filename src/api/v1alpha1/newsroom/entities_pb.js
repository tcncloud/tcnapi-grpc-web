...
goog.exportSymbol('proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest', null, global);
goog.exportSymbol('proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.displayName = 'proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.displayName = 'proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse';
}
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
newArticleSid: jspb.Message.getFieldWithDefault(msg, 1, "0")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest;
  return proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNewArticleSid();
  if (parseInt(f, 10) !== 0) {
    writer.writeInt64String(
 ...
 * @return {string}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.prototype.getNewArticleSid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest} returns this
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdRequest.prototype.setNewArticleSid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
articleDetails: (f = msg.getArticleDetails()) && proto.api.v1alpha1.newsroom.NewsArticleDetails.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse;
  return proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getArticleDetails();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.v1alpha1.newsroom.NewsArticleDetails}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.getArticleDetails = function() {
  return /** @type{?proto.api.v1alpha1.newsroom.NewsArticleDetails} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.newsroom.NewsArticleDetails, 1));
};
...
/**
 * @param {?proto.api.v1alpha1.newsroom.NewsArticleDetails|undefined} value
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse} returns this
*/
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.setArticleDetails = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse} returns this
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.clearArticleDetails = function() {
  return this.setArticleDetails(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.newsroom.GetClientArticleByIdResponse.prototype.hasArticleDetails = function() {
  return jspb.Message.getField(this, 1) != null;
};
