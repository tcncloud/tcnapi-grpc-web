...
export class GetClientArticleByIdRequest extends jspb.Message {
  getNewArticleSid(): string;
  setNewArticleSid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetClientArticleByIdRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetClientArticleByIdRequest): GetClientArticleByIdRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetClientArticleByIdRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetClientArticleByIdRequest;
  static deserializeBinaryFromReader(message: GetClientArticleByIdRequest, reader: jspb.BinaryReader): GetClientArticleByIdRequest;
}

export namespace GetClientArticleByIdRequest {
  export type AsObject = {
    newArticleSid: string,
  }
}

export class GetClientArticleByIdResponse extends jspb.Message {
  hasArticleDetails(): boolean;
  clearArticleDetails(): void;
  getArticleDetails(): NewsArticleDetails | undefined;
  setArticleDetails(value?: NewsArticleDetails): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetClientArticleByIdResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetClientArticleByIdResponse): GetClientArticleByIdResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetClientArticleByIdResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetClientArticleByIdResponse;
  static deserializeBinaryFromReader(message: GetClientArticleByIdResponse, reader: jspb.BinaryReader): GetClientArticleByIdResponse;
}

export namespace GetClientArticleByIdResponse {
  export type AsObject = {
    articleDetails?: NewsArticleDetails.AsObject,
  }
}
