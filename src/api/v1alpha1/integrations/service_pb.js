 ...
 * @const
 */
proto.api.v1alpha1.integrations.CalculateFeesReq.repeatedFields_ = [2];
...
proto.api.v1alpha1.integrations.CalculateFeesReq.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getParamsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.api.v1alpha1.integrations.Value.serializeBinaryToWriter);
  }
  f = message.getCallSid();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {!proto.api.v1alpha1.integrations.CalculateFeesRes} returns this
 */
proto.api.v1alpha1.integrations.CalculateFeesRes.prototype.clearTotalAmountDue = function() {
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.integrations.CalculateFeesRes.prototype.hasTotalAmountDue = function() {
  return jspb.Message.getField(this, 2) != null;
};
