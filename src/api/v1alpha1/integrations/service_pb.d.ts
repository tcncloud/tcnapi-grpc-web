...
export class CallEpicPatientReq extends jspb.Message {
  getPhoneagentid(): string;
  setPhoneagentid(value: string): void;

  getOriginphoneextension(): string;
  setOriginphoneextension(value: string): void;

  getPhonenumber(): string;
  setPhonenumber(value: string): void;

  getEpiccallid(): string;
  setEpiccallid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CallEpicPatientReq.AsObject;
  static toObject(includeInstance: boolean, msg: CallEpicPatientReq): CallEpicPatientReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CallEpicPatientReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CallEpicPatientReq;
  static deserializeBinaryFromReader(message: CallEpicPatientReq, reader: jspb.BinaryReader): CallEpicPatientReq;
}

export namespace CallEpicPatientReq {
  export type AsObject = {
    phoneagentid: string,
...
export class CallEpicPatientRes extends jspb.Message {
  getPhonesystemcallid(): string;
  setPhonesystemcallid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CallEpicPatientRes.AsObject;
  static toObject(includeInstance: boolean, msg: CallEpicPatientRes): CallEpicPatientRes.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CallEpicPatientRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CallEpicPatientRes;
  static deserializeBinaryFromReader(message: CallEpicPatientRes, reader: jspb.BinaryReader): CallEpicPatientRes;
}

export namespace CallEpicPatientRes {
  export type AsObject = {
    phonesystemcallid: string,
  }
}

export class HangUpEpicPatientCallReq extends jspb.Message {
  getPhoneagentid(): string;
  setPhoneagentid(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): HangUpEpicPatientCallReq.AsObject;
  static toObject(includeInstance: boolean, msg: HangUpEpicPatientCallReq): HangUpEpicPatientCallReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: HangUpEpicPatientCallReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): HangUpEpicPatientCallReq;
  static deserializeBinaryFromReader(message: HangUpEpicPatientCallReq, reader: jspb.BinaryReader): HangUpEpicPatientCallReq;
}

export namespace HangUpEpicPatientCallReq {
  export type AsObject = {
    phoneagentid: string,
    originphoneextension: string,
    epiccallid: string,
...
export class Action extends jspb.Message {
  ...
  getRestructureBeforeMap(): jspb.Map<string, string>;
