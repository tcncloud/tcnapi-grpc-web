...
goog.exportSymbol('proto.api.v1alpha1.integrations.ClonePluginInstanceReq', null, global);
goog.exportSymbol('proto.api.v1alpha1.integrations.ClonePluginInstanceRes', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.integrations.ClonePluginInstanceReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.integrations.ClonePluginInstanceReq.displayName = 'proto.api.v1alpha1.integrations.ClonePluginInstanceReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.integrations.ClonePluginInstanceRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.integrations.ClonePluginInstanceRes.displayName = 'proto.api.v1alpha1.integrations.ClonePluginInstanceRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.integrations.ClonePluginInstanceReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.toObject = function(includeInstance, msg) {
  var f, obj = {
entity: (f = msg.getEntity()) && api_v1alpha1_integrations_service_pb.PluginInstanceId.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.integrations.ClonePluginInstanceReq;
  return proto.api.v1alpha1.integrations.ClonePluginInstanceReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.integrations.ClonePluginInstanceReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEntity();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.v1alpha1.integrations.PluginInstanceId}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.getEntity = function() {
  return /** @type{?proto.api.v1alpha1.integrations.PluginInstanceId} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_integrations_service_pb.PluginInstanceId, 1));
};
...
/**
 * @param {?proto.api.v1alpha1.integrations.PluginInstanceId|undefined} value
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} returns this
*/
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.setEntity = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} returns this
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.clearEntity = function() {
  return this.setEntity(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.hasEntity = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.getNewPluginName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceReq} returns this
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceReq.prototype.setNewPluginName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.integrations.ClonePluginInstanceRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.toObject = function(includeInstance, msg) {
  var f, obj = {
entity: (f = msg.getEntity()) && api_v1alpha1_integrations_service_pb.PluginInstanceId.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.integrations.ClonePluginInstanceRes;
  return proto.api.v1alpha1.integrations.ClonePluginInstanceRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.integrations.ClonePluginInstanceRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEntity();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.v1alpha1.integrations.PluginInstanceId}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.getEntity = function() {
  return /** @type{?proto.api.v1alpha1.integrations.PluginInstanceId} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_integrations_service_pb.PluginInstanceId, 1));
};
...
/**
 * @param {?proto.api.v1alpha1.integrations.PluginInstanceId|undefined} value
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes} returns this
*/
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.setEntity = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.integrations.ClonePluginInstanceRes} returns this
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.clearEntity = function() {
  return this.setEntity(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.integrations.ClonePluginInstanceRes.prototype.hasEntity = function() {
  return jspb.Message.getField(this, 1) != null;
};
