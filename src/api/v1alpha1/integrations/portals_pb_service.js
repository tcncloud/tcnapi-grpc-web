...
PortalManagerApi.DuplicatePluginInstance = {
  methodName: "DuplicatePluginInstance",
  service: PortalManagerApi,
  requestStream: false,
  responseStream: false,
  requestType: api_v1alpha1_integrations_portals_pb.DuplicatePluginInstanceReq,
  responseType: api_v1alpha1_integrations_portals_pb.DuplicatePluginInstanceRes
};
...
PortalManagerApiClient.prototype.duplicatePluginInstance = function duplicatePluginInstance(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(PortalManagerApi.DuplicatePluginInstance, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
