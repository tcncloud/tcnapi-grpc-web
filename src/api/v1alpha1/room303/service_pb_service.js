...
Room303API.UpdateRoom = {
  methodName: "UpdateRoom",
  service: Room303API,
  requestStream: false,
  responseStream: false,
  requestType: api_v1alpha1_room303_room_pb.UpdateRoomRequest,
  responseType: api_commons_room303_pb.Room
};
...
Room303APIClient.prototype.updateRoom = function updateRoom(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Room303API.UpdateRoom, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
