...
// file: api/v1alpha1/org/legacy/entities.proto
...
export class GetAgentProfileGroupResponse extends jspb.Message {
  ...
  getAgentProfileGroup(): AgentProfileGroup | undefined;
  setAgentProfileGroup(value?: AgentProfileGroup): void;
...
export namespace GetAgentProfileGroupResponse {
  export type AsObject = {
    agentProfileGroup?: AgentProfileGroup.AsObject,
  }
}
...
export class ListAgentProfileGroupsResponse extends jspb.Message {
  ...
  getAgentProfileGroupsList(): Array<AgentProfileGroup>;
  setAgentProfileGroupsList(value: Array<AgentProfileGroup>): void;
  addAgentProfileGroups(value?: AgentProfileGroup, index?: number): AgentProfileGroup;
...
export namespace ListAgentProfileGroupsResponse {
  export type AsObject = {
    agentProfileGroupsList: Array<AgentProfileGroup.AsObject>,
  }
}
