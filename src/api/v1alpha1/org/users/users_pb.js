...
goog.exportSymbol('proto.api.v1alpha1.org.users.ListUserDirectoriesRequest', null, global);
goog.exportSymbol('proto.api.v1alpha1.org.users.ListUserDirectoriesResponse', null, global);
...
goog.exportSymbol('proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest', null, global);
goog.exportSymbol('proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse', null, global);
...
goog.exportSymbol('proto.api.v1alpha1.org.users.UserDirectoryEntry', null, global);
/**
 ...
 * @constructor
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.displayName = 'proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.displayName = 'proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.org.users.UserDirectoryEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.org.users.UserDirectoryEntry.displayName = 'proto.api.v1alpha1.org.users.UserDirectoryEntry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.org.users.ListUserDirectoriesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.displayName = 'proto.api.v1alpha1.org.users.ListUserDirectoriesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.org.users.ListUserDirectoriesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.displayName = 'proto.api.v1alpha1.org.users.ListUserDirectoriesResponse';
}
 ...
 * @const
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    userIdsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest;
  return proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserIdsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array<string>}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.getUserIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.setUserIdsList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.addUserIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.clearUserIdsList = function() {
  return this.setUserIdsList([]);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.getDisable = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledRequest.prototype.setDisable = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};
 ...
 * @const
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    updatedIdsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse;
  return proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUpdatedIdsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      1,
      f
 ...
 * @return {!Array<string>}
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.getUpdatedIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.setUpdatedIdsList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.addUpdatedIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse} returns this
 */
proto.api.v1alpha1.org.users.UpdateBulkUsersDisabledResponse.prototype.clearUpdatedIdsList = function() {
  return this.setUpdatedIdsList([]);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.org.users.UserDirectoryEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.org.users.UserDirectoryEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.org.users.UserDirectoryEntry;
  return proto.api.v1alpha1.org.users.UserDirectoryEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.org.users.UserDirectoryEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.org.users.UserDirectoryEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.org.users.UserDirectoryEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry} returns this
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.getFullName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry} returns this
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.setFullName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.getUserName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry} returns this
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.setUserName = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.getFirstName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry} returns this
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.setFirstName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.getLastName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry} returns this
 */
proto.api.v1alpha1.org.users.UserDirectoryEntry.prototype.setLastName = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    agentsOnly: jspb.Message.getBooleanFieldWithDefault(msg, 1, false)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.org.users.ListUserDirectoriesRequest;
  return proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAgentsOnly();
  if (f) {
    writer.writeBool(
      1,
      f
...
/**
 * optional bool agents_only = 1;
 * @return {boolean}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.prototype.getAgentsOnly = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
...
/**
 * @param {boolean} value
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesRequest} returns this
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesRequest.prototype.setAgentsOnly = function(value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};
 ...
 * @const
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    userDirectoriesList: jspb.Message.toObjectList(msg.getUserDirectoriesList(),
    proto.api.v1alpha1.org.users.UserDirectoryEntry.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.org.users.ListUserDirectoriesResponse;
  return proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.v1alpha1.org.users.UserDirectoryEntry;
      reader.readMessage(value,proto.api.v1alpha1.org.users.UserDirectoryEntry.deserializeBinaryFromReader);
      msg.addUserDirectories(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserDirectoriesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.v1alpha1.org.users.UserDirectoryEntry.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated UserDirectoryEntry user_directories = 1;
 * @return {!Array<!proto.api.v1alpha1.org.users.UserDirectoryEntry>}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.getUserDirectoriesList = function() {
  return /** @type{!Array<!proto.api.v1alpha1.org.users.UserDirectoryEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.v1alpha1.org.users.UserDirectoryEntry, 1));
};


/**
 * @param {!Array<!proto.api.v1alpha1.org.users.UserDirectoryEntry>} value
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse} returns this
*/
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.setUserDirectoriesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.v1alpha1.org.users.UserDirectoryEntry=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.v1alpha1.org.users.UserDirectoryEntry}
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.addUserDirectories = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.v1alpha1.org.users.UserDirectoryEntry, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.org.users.ListUserDirectoriesResponse} returns this
 */
proto.api.v1alpha1.org.users.ListUserDirectoriesResponse.prototype.clearUserDirectoriesList = function() {
  return this.setUserDirectoriesList([]);
};
