...
proto.api.v1alpha1.bireportgenerator.ReportJob.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cronExpression: (f = msg.getCronExpression()) && api_commons_bireportgenerator_pb.CronExpression.toObject(includeInstance, f)
  };
...
proto.api.v1alpha1.bireportgenerator.ReportJob.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 17:
      ...
      break;
    case 18:
      var value = new api_commons_bireportgenerator_pb.CronExpression;
      reader.readMessage(value,api_commons_bireportgenerator_pb.CronExpression.deserializeBinaryFromReader);
...
proto.api.v1alpha1.bireportgenerator.ReportJob.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      api_commons_bireportgenerator_pb.CronExpression.serializeBinaryToWriter
    );
  }
};
...
proto.api.v1alpha1.bireportgenerator.ReportJob.prototype.getCronExpression = function() {
  return /** @type{?proto.api.commons.CronExpression} */ (
    jspb.Message.getWrapperField(this, api_commons_bireportgenerator_pb.CronExpression, 18));
};
