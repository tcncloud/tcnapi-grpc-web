 ...
 * @const
 */
proto.api.v1alpha1.contactmanager.GetKYCEncContactEntryRequest.repeatedFields_ = [2];
...
proto.api.v1alpha1.contactmanager.GetKYCKeysResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    entryValList: jspb.Message.toObjectList(msg.getEntryValList(),
    api_commons_contactmanager_pb.ContactManagerEntryVal.toObject, includeInstance),
    minKycLimit: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
/**
 * repeated api.commons.ContactManagerEntryVal entry_val = 1;
 * @return {!Array<!proto.api.commons.ContactManagerEntryVal>}
 */
proto.api.v1alpha1.contactmanager.GetKYCKeysResponse.prototype.getEntryValList = function() {
  return /** @type{!Array<!proto.api.commons.ContactManagerEntryVal>} */ (
    jspb.Message.getRepeatedWrapperField(this, api_commons_contactmanager_pb.ContactManagerEntryVal, 1));
};
 ...
 * @return {!proto.api.commons.ContactManagerEntryVal}
 */
proto.api.v1alpha1.contactmanager.GetKYCKeysResponse.prototype.addEntryVal = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.commons.ContactManagerEntryVal, opt_index);
};
...
/**
 * optional int64 min_kyc_limit = 2;
 * @return {number}
 */
proto.api.v1alpha1.contactmanager.GetKYCKeysResponse.prototype.getMinKycLimit = function() {
 ...
 * @return {!proto.api.v1alpha1.contactmanager.GetKYCKeysResponse} returns this
 */
proto.api.v1alpha1.contactmanager.GetKYCKeysResponse.prototype.setMinKycLimit = function(value) {
