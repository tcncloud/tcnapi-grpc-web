...
goog.exportSymbol('proto.api.v1alpha1.delivery.UserDefaultSSH', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.delivery.UserDefaultSSH = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.delivery.UserDefaultSSH, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.delivery.UserDefaultSSH.displayName = 'proto.api.v1alpha1.delivery.UserDefaultSSH';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.api.v1alpha1.delivery.CredentialData.oneofGroups_ = [[1,2,3,4,5,6]];
...
proto.api.v1alpha1.delivery.CredentialData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    userDefaultSsh: (f = msg.getUserDefaultSsh()) && proto.api.v1alpha1.delivery.UserDefaultSSH.toObject(includeInstance, f)
  };
...
proto.api.v1alpha1.delivery.CredentialData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.api.v1alpha1.delivery.UserDefaultSSH;
      reader.readMessage(value,proto.api.v1alpha1.delivery.UserDefaultSSH.deserializeBinaryFromReader);
      msg.setUserDefaultSsh(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.api.v1alpha1.delivery.CredentialData.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getUserDefaultSsh();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.api.v1alpha1.delivery.UserDefaultSSH.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional UserDefaultSSH user_default_ssh = 6;
 * @return {?proto.api.v1alpha1.delivery.UserDefaultSSH}
 */
proto.api.v1alpha1.delivery.CredentialData.prototype.getUserDefaultSsh = function() {
  return /** @type{?proto.api.v1alpha1.delivery.UserDefaultSSH} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.delivery.UserDefaultSSH, 6));
};


/**
 * @param {?proto.api.v1alpha1.delivery.UserDefaultSSH|undefined} value
 * @return {!proto.api.v1alpha1.delivery.CredentialData} returns this
*/
proto.api.v1alpha1.delivery.CredentialData.prototype.setUserDefaultSsh = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.api.v1alpha1.delivery.CredentialData.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.v1alpha1.delivery.CredentialData} returns this
 */
proto.api.v1alpha1.delivery.CredentialData.prototype.clearUserDefaultSsh = function() {
  return this.setUserDefaultSsh(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.delivery.CredentialData.prototype.hasUserDefaultSsh = function() {
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.delivery.UserDefaultSSH.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.delivery.UserDefaultSSH} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.toObject = function(includeInstance, msg) {
  var f, obj = {
    username: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!proto.api.v1alpha1.delivery.UserDefaultSSH}
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.delivery.UserDefaultSSH;
  return proto.api.v1alpha1.delivery.UserDefaultSSH.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.delivery.UserDefaultSSH} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.delivery.UserDefaultSSH}
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.delivery.UserDefaultSSH.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.delivery.UserDefaultSSH} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUsername();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.delivery.UserDefaultSSH} returns this
 */
proto.api.v1alpha1.delivery.UserDefaultSSH.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
