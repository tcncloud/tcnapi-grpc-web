...
goog.exportSymbol('proto.api.v1alpha1.explorer.ResultUrlsEntry', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.explorer.ResultUrlsEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.explorer.ResultUrlsEntry.displayName = 'proto.api.v1alpha1.explorer.ResultUrlsEntry';
}
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.explorer.ResultUrlsEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.explorer.ResultUrlsEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
key: jspb.Message.getFieldWithDefault(msg, 1, 0),
value: (f = msg.getValue()) && proto.api.v1alpha1.explorer.ResultFile.toObject(includeInstance, f)
  };
 ...
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.explorer.ResultUrlsEntry;
  return proto.api.v1alpha1.explorer.ResultUrlsEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.explorer.ResultUrlsEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.explorer.ResultUrlsEntry}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.api.v1alpha1.explorer.ResultType} */ (reader.readEnum());
      msg.setKey(value);
      break;
    case 2:
      var value = new proto.api.v1alpha1.explorer.ResultFile;
      reader.readMessage(value,proto.api.v1alpha1.explorer.ResultFile.deserializeBinaryFromReader);
      msg.setValue(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.explorer.ResultUrlsEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.explorer.ResultUrlsEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f !== 0.0) {
    writer.writeEnum(
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.api.v1alpha1.explorer.ResultFile.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ResultType key = 1;
 * @return {!proto.api.v1alpha1.explorer.ResultType}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.getKey = function() {
  return /** @type {!proto.api.v1alpha1.explorer.ResultType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.api.v1alpha1.explorer.ResultType} value
 * @return {!proto.api.v1alpha1.explorer.ResultUrlsEntry} returns this
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.setKey = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional ResultFile value = 2;
 * @return {?proto.api.v1alpha1.explorer.ResultFile}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.getValue = function() {
  return /** @type{?proto.api.v1alpha1.explorer.ResultFile} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.explorer.ResultFile, 2));
};


/**
 * @param {?proto.api.v1alpha1.explorer.ResultFile|undefined} value
 * @return {!proto.api.v1alpha1.explorer.ResultUrlsEntry} returns this
*/
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.setValue = function(value) {
 ...
 * @return {!proto.api.v1alpha1.explorer.ResultUrlsEntry} returns this
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.ResultUrlsEntry.prototype.hasValue = function() {
