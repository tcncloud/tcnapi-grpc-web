 ...
 * @constructor
 */
proto.api.v1alpha1.explorer.ResultUrlEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.explorer.ResultUrlEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.explorer.ResultUrlEntry.displayName = 'proto.api.v1alpha1.explorer.ResultUrlEntry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.explorer.ResultUrlEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.explorer.ResultUrlEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.explorer.ResultUrlEntry;
  return proto.api.v1alpha1.explorer.ResultUrlEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.explorer.ResultUrlEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.explorer.ResultUrlEntry}
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.explorer.ResultUrlEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.explorer.ResultUrlEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.getKey = function() {
 ...
 * @return {!proto.api.v1alpha1.explorer.ResultUrlEntry} returns this
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.setKey = function(value) {
 ...
 * @return {?proto.api.v1alpha1.explorer.ResultFile}
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.getValue = function() {
 ...
 * @return {!proto.api.v1alpha1.explorer.ResultUrlEntry} returns this
*/
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.setValue = function(value) {
 ...
 * @return {!proto.api.v1alpha1.explorer.ResultUrlEntry} returns this
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.ResultUrlEntry.prototype.hasValue = function() {
