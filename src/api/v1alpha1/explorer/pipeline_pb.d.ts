...
export class Pipeline extends jspb.Message {
  ...
  hasFormatQuery(): boolean;
  clearFormatQuery(): void;
  getFormatQuery(): FormatQuery | undefined;
  setFormatQuery(value?: FormatQuery): void;
...
export namespace Pipeline {
  export type AsObject = {
    ...
    formatQuery?: FormatQuery.AsObject,
  }
}
...
export class FormatQuery extends jspb.Message {
  clearTableColumnConfigsList(): void;
  getTableColumnConfigsList(): Array<TableColumnConfig>;
  setTableColumnConfigsList(value: Array<TableColumnConfig>): void;
  addTableColumnConfigs(value?: TableColumnConfig, index?: number): TableColumnConfig;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): FormatQuery.AsObject;
  static toObject(includeInstance: boolean, msg: FormatQuery): FormatQuery.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: FormatQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): FormatQuery;
  static deserializeBinaryFromReader(message: FormatQuery, reader: jspb.BinaryReader): FormatQuery;
}

export namespace FormatQuery {
  export type AsObject = {
    tableColumnConfigsList: Array<TableColumnConfig.AsObject>,
  }
}
...
export class TableColumnConfig extends jspb.Message {
  ...
  getColumnSummary(): ColumnSummaryTypeMap[keyof ColumnSummaryTypeMap];
  setColumnSummary(value: ColumnSummaryTypeMap[keyof ColumnSummaryTypeMap]): void;
...
export interface ColumnSummaryTypeMap {
...
export const ColumnSummaryType: ColumnSummaryTypeMap;
