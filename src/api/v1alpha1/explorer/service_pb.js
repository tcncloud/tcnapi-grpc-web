...
goog.exportSymbol('proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest', null, global);
goog.exportSymbol('proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.QueryCase', null, global);
goog.exportSymbol('proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.repeatedFields_, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_);
};
goog.inherits(proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.displayName = 'proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.displayName = 'proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse';
}
 ...
 * @const
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.repeatedFields_ = [5];
 ...
 * @const
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_ = [[3,4]];

/**
 * @enum {number}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.QueryCase = {
  QUERY_NOT_SET: 0,
  PIPELINE: 3,
  PRQL: 4
};
...
/**
 * @return {proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.QueryCase}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getQueryCase = function() {
  return /** @type {proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.QueryCase} */(jspb.Message.computeOneofCase(this, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
datasourceName: jspb.Message.getFieldWithDefault(msg, 1, ""),
datasourceType: jspb.Message.getFieldWithDefault(msg, 2, 0),
pipeline: (f = jspb.Message.getField(msg, 3)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest;
  return proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDatasourceName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getDatasourceName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setDatasourceName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.DatasourceType}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getDatasourceType = function() {
  return /** @type {!proto.api.v1alpha1.explorer.DatasourceType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setDatasourceType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getPipeline = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setPipeline = function(value) {
  return jspb.Message.setOneofField(this, 3, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearPipeline = function() {
  return jspb.Message.setOneofField(this, 3, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.hasPipeline = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getPrql = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setPrql = function(value) {
  return jspb.Message.setOneofField(this, 4, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearPrql = function() {
  return jspb.Message.setOneofField(this, 4, proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.hasPrql = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {!Array<string>}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getOrgIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 5));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setOrgIdsList = function(value) {
  return jspb.Message.setField(this, 5, value || []);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.addOrgIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 5, value, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearOrgIdsList = function() {
  return this.setOrgIdsList([]);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getStartTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 6));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
*/
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setStartTime = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearStartTime = function() {
  return this.setStartTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.hasStartTime = function() {
  return jspb.Message.getField(this, 6) != null;
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getEndTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 7));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
*/
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setEndTime = function(value) {
  return jspb.Message.setWrapperField(this, 7, value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearEndTime = function() {
  return this.setEndTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.hasEndTime = function() {
  return jspb.Message.getField(this, 7) != null;
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getTimezone = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setTimezone = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};
 ...
 * @return {?proto.api.v1alpha1.explorer.Parameters}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getPipelineParameters = function() {
  return /** @type{?proto.api.v1alpha1.explorer.Parameters} */ (
    jspb.Message.getWrapperField(this, api_v1alpha1_explorer_entities_pb.Parameters, 9));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
*/
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setPipelineParameters = function(value) {
  return jspb.Message.setWrapperField(this, 9, value);
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.clearPipelineParameters = function() {
  return this.setPipelineParameters(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.hasPipelineParameters = function() {
  return jspb.Message.getField(this, 9) != null;
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getUiTraceId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 10, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setUiTraceId = function(value) {
  return jspb.Message.setProto3StringField(this, 10, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.getComment = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 11, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryRequest.prototype.setComment = function(value) {
  return jspb.Message.setProto3StringField(this, 11, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
prql: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse;
  return proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPrql();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * optional string prql = 1;
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.getPrql = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.setPrql = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.getSql = function() {
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.setSql = function(value) {
 ...
 * @return {string}
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.getExplain = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse} returns this
 */
proto.api.v1alpha1.explorer.GetInsightSupportQueryResponse.prototype.setExplain = function(value) {
