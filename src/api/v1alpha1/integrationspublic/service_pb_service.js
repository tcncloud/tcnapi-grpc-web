...
IntegrationsPublic.CalculateFees = {
  methodName: "CalculateFees",
  service: IntegrationsPublic,
  requestStream: false,
  responseStream: false,
  requestType: api_v1alpha1_integrationspublic_service_pb.CalculateFeesReq,
...
IntegrationsPublicClient.prototype.calculateFees = function calculateFees(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
