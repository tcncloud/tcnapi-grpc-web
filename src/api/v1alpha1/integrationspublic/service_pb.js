...
goog.exportSymbol('proto.api.v1alpha1.integrationspublic.DeliverReceiptReq', null, global);
goog.exportSymbol('proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.DeliveryMethodCase', null, global);
goog.exportSymbol('proto.api.v1alpha1.integrationspublic.DeliverReceiptRes', null, global);
goog.exportSymbol('proto.api.v1alpha1.integrationspublic.EmailReceipt', null, global);
 ...
 * @constructor
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.oneofGroups_);
};
goog.inherits(proto.api.v1alpha1.integrationspublic.DeliverReceiptReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.displayName = 'proto.api.v1alpha1.integrationspublic.DeliverReceiptReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.integrationspublic.EmailReceipt, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.integrationspublic.EmailReceipt.displayName = 'proto.api.v1alpha1.integrationspublic.EmailReceipt';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.v1alpha1.integrationspublic.DeliverReceiptRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.displayName = 'proto.api.v1alpha1.integrationspublic.DeliverReceiptRes';
}
 ...
 * @const
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.oneofGroups_ = [[3]];

/**
 * @enum {number}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.DeliveryMethodCase = {
  DELIVERY_METHOD_NOT_SET: 0,
  EMAIL_RECEIPT: 3
};

/**
 * @return {proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.DeliveryMethodCase}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.getDeliveryMethodCase = function() {
  return /** @type {proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.DeliveryMethodCase} */(jspb.Message.computeOneofCase(this, proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.integrationspublic.DeliverReceiptReq;
  return proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.api.v1alpha1.integrationspublic.EmailReceipt.serializeBinaryToWriter
    );
  }
  f = message.getReceiptId();
  if (f.length > 0) {
...
/**
 * optional EmailReceipt email_receipt = 3;
 * @return {?proto.api.v1alpha1.integrationspublic.EmailReceipt}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.getEmailReceipt = function() {
  return /** @type{?proto.api.v1alpha1.integrationspublic.EmailReceipt} */ (
    jspb.Message.getWrapperField(this, proto.api.v1alpha1.integrationspublic.EmailReceipt, 3));
};


/**
 * @param {?proto.api.v1alpha1.integrationspublic.EmailReceipt|undefined} value
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} returns this
*/
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.setEmailReceipt = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} returns this
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.clearEmailReceipt = function() {
  return this.setEmailReceipt(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.hasEmailReceipt = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional string receipt_id = 6;
 * @return {string}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.getReceiptId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};
 ...
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptReq} returns this
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptReq.prototype.setReceiptId = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.integrationspublic.EmailReceipt.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.integrationspublic.EmailReceipt} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.v1alpha1.integrationspublic.EmailReceipt}
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.integrationspublic.EmailReceipt;
  return proto.api.v1alpha1.integrationspublic.EmailReceipt.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.integrationspublic.EmailReceipt} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.integrationspublic.EmailReceipt}
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.integrationspublic.EmailReceipt.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.integrationspublic.EmailReceipt} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getToAddr();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.prototype.getToAddr = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.v1alpha1.integrationspublic.EmailReceipt} returns this
 */
proto.api.v1alpha1.integrationspublic.EmailReceipt.prototype.setToAddr = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptRes}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.integrationspublic.DeliverReceiptRes;
  return proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.integrationspublic.DeliverReceiptRes}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.integrationspublic.DeliverReceiptRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.integrationspublic.DeliverReceiptRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
