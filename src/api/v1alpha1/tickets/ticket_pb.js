...
goog.exportSymbol('proto.api.v1alpha1.tickets.EditCustomFieldResponse', null, global);
...
proto.api.v1alpha1.tickets.CreateCustomFieldRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.tickets.CreateCustomFieldRequest.repeatedFields_, null);
};
...
proto.api.v1alpha1.tickets.CreateCustomFieldResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.tickets.CreateCustomFieldResponse.repeatedFields_, null);
};
...
proto.api.v1alpha1.tickets.EditCustomFieldRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.tickets.EditCustomFieldRequest.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.v1alpha1.tickets.EditCustomFieldResponse.repeatedFields_, null);
};
goog.inherits(proto.api.v1alpha1.tickets.EditCustomFieldResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.v1alpha1.tickets.EditCustomFieldResponse.displayName = 'proto.api.v1alpha1.tickets.EditCustomFieldResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.repeatedFields_ = [3];
 ...
 * @return {string}
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.getTicketCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.setTicketCode = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.getCustomFieldList = function() {
 ...
 * @return {!proto.api.v1alpha1.tickets.CreateCustomFieldRequest} returns this
*/
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.setCustomFieldList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.addCustomField = function(opt_value, opt_index) {
 ...
 * @return {!proto.api.v1alpha1.tickets.CreateCustomFieldRequest} returns this
 */
proto.api.v1alpha1.tickets.CreateCustomFieldRequest.prototype.clearCustomFieldList = function() {
  return this.setCustomFieldList([]);
};
 ...
 * @const
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.repeatedFields_ = [3];
 ...
 * @return {string}
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.getTicketCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.setTicketCode = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<!proto.api.commons.CustomField>}
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.getCustomFieldList = function() {
  return /** @type{!Array<!proto.api.commons.CustomField>} */ (
    jspb.Message.getRepeatedWrapperField(this, api_commons_tickets_pb.CustomField, 3));
};
 ...
 * @return {!proto.api.v1alpha1.tickets.CreateCustomFieldResponse} returns this
*/
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.setCustomFieldList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.api.commons.CustomField}
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.addCustomField = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.api.commons.CustomField, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.tickets.CreateCustomFieldResponse} returns this
 */
proto.api.v1alpha1.tickets.CreateCustomFieldResponse.prototype.clearCustomFieldList = function() {
  return this.setCustomFieldList([]);
};
 ...
 * @const
 */
proto.api.v1alpha1.tickets.EditCustomFieldRequest.repeatedFields_ = [3];
 ...
 * @return {!Array<!proto.api.commons.CustomField>}
 */
proto.api.v1alpha1.tickets.EditCustomFieldRequest.prototype.getEditValueList = function() {
  return /** @type{!Array<!proto.api.commons.CustomField>} */ (
    jspb.Message.getRepeatedWrapperField(this, api_commons_tickets_pb.CustomField, 3));
};
 ...
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldRequest} returns this
*/
proto.api.v1alpha1.tickets.EditCustomFieldRequest.prototype.setEditValueList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.api.commons.CustomField}
 */
proto.api.v1alpha1.tickets.EditCustomFieldRequest.prototype.addEditValue = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.api.commons.CustomField, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldRequest} returns this
 */
proto.api.v1alpha1.tickets.EditCustomFieldRequest.prototype.clearEditValueList = function() {
  return this.setEditValueList([]);
};
 ...
 * @const
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api.v1alpha1.tickets.EditCustomFieldResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.v1alpha1.tickets.EditCustomFieldResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldResponse}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.v1alpha1.tickets.EditCustomFieldResponse;
  return proto.api.v1alpha1.tickets.EditCustomFieldResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.v1alpha1.tickets.EditCustomFieldResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldResponse}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      var value = new api_commons_tickets_pb.CustomField;
      reader.readMessage(value,api_commons_tickets_pb.CustomField.deserializeBinaryFromReader);
      msg.addEditedCustomField(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.v1alpha1.tickets.EditCustomFieldResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.v1alpha1.tickets.EditCustomFieldResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTicketCode();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getEditedCustomFieldList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
 ...
 * @return {string}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.getTicketCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.setTicketCode = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<!proto.api.commons.CustomField>}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.getEditedCustomFieldList = function() {
  return /** @type{!Array<!proto.api.commons.CustomField>} */ (
    jspb.Message.getRepeatedWrapperField(this, api_commons_tickets_pb.CustomField, 3));
};
 ...
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldResponse} returns this
*/
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.setEditedCustomFieldList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.api.commons.CustomField}
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.addEditedCustomField = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.api.commons.CustomField, opt_index);
};
 ...
 * @return {!proto.api.v1alpha1.tickets.EditCustomFieldResponse} returns this
 */
proto.api.v1alpha1.tickets.EditCustomFieldResponse.prototype.clearEditedCustomFieldList = function() {
  return this.setEditedCustomFieldList([]);
};
