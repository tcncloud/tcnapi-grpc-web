...
goog.exportSymbol('proto.api.commons.WhatsAppMsgType', null, global);
/**
...
proto.api.commons.OmniTextMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.api.commons.WhatsAppMsgType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 5:
      var value = /** @type {boolean} */ (reader.readBool());
...
/**
 * optional WhatsAppMsgType type = 4;
 * @return {!proto.api.commons.WhatsAppMsgType}
 */
proto.api.commons.OmniTextMessage.prototype.getType = function() {
  return /** @type {!proto.api.commons.WhatsAppMsgType} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/**
 * @param {!proto.api.commons.WhatsAppMsgType} value
 * @return {!proto.api.commons.OmniTextMessage} returns this
 */
proto.api.commons.OmniTextMessage.prototype.setType = function(value) {
  return jspb.Message.setProto3EnumField(this, 4, value);
};
 ...
 * @return {boolean}
 */
proto.api.commons.OmniTextMessage.prototype.getPreviewUrl = function() {
 ...
 * @return {!proto.api.commons.OmniTextMessage} returns this
 */
proto.api.commons.OmniTextMessage.prototype.setPreviewUrl = function(value) {
 ...
 * @enum {number}
 */
proto.api.commons.WhatsAppMsgType = {
