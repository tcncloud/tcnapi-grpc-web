...
goog.exportSymbol('api.commons.AgentAssignmentActiveSearchType', null, proto);
goog.exportSymbol('api.commons.AgentChatWidgetMessage', null, proto);
goog.exportSymbol('api.commons.AgentConversationAssignmentStatus', null, proto);
goog.exportSymbol('api.commons.AgentConversationAssignmentType', null, proto);
goog.exportSymbol('api.commons.CampaignDirection', null, proto);
goog.exportSymbol('api.commons.CampaignStatus', null, proto);
goog.exportSymbol('api.commons.ChannelType', null, proto);
goog.exportSymbol('api.commons.ComplianceRule', null, proto);
goog.exportSymbol('api.commons.ComplianceRuleSet', null, proto);
goog.exportSymbol('api.commons.ConnectedInbox', null, proto);
goog.exportSymbol('api.commons.ConnectedInboxAuthenticationType', null, proto);
goog.exportSymbol('api.commons.ConnectedInboxOAuthConfig', null, proto);
goog.exportSymbol('api.commons.ContactEntry', null, proto);
goog.exportSymbol('api.commons.ContactList', null, proto);
goog.exportSymbol('api.commons.ContactList.Metadata', null, proto);
goog.exportSymbol('api.commons.ConversationCollectedData', null, proto);
goog.exportSymbol('api.commons.ConversationCollectedData_Item', null, proto);
goog.exportSymbol('api.commons.ConversationCustomerInformation', null, proto);
goog.exportSymbol('api.commons.ConversationStateChangeTimerName', null, proto);
goog.exportSymbol('api.commons.ConversationStatus', null, proto);
goog.exportSymbol('api.commons.ConversationTimeoutMessageConfig', null, proto);
goog.exportSymbol('api.commons.CustomerChatWidgetMessage', null, proto);
goog.exportSymbol('api.commons.CustomerCollectedData', null, proto);
goog.exportSymbol('api.commons.CustomerCollectedDataItem', null, proto);
goog.exportSymbol('api.commons.Disposition', null, proto);
goog.exportSymbol('api.commons.GetQueuesDetailsRes', null, proto);
goog.exportSymbol('api.commons.GetQueuesDetailsRes.QueueDetails', null, proto);
goog.exportSymbol('api.commons.MessageFormat', null, proto);
goog.exportSymbol('api.commons.OmniAssignConversation', null, proto);
goog.exportSymbol('api.commons.OmniAttachment', null, proto);
goog.exportSymbol('api.commons.OmniAttachmentUploadURL', null, proto);
goog.exportSymbol('api.commons.OmniCampaign', null, proto);
goog.exportSymbol('api.commons.OmniCampaignDirection', null, proto);
goog.exportSymbol('api.commons.OmniCampaignModule', null, proto);
goog.exportSymbol('api.commons.OmniCampaignModule.Details', null, proto);
goog.exportSymbol('api.commons.OmniCampaignModuleConfig', null, proto);
goog.exportSymbol('api.commons.OmniCampaignModuleStatus', null, proto);
goog.exportSymbol('api.commons.OmniCampaignModuleType', null, proto);
goog.exportSymbol('api.commons.OmniCampaignStatus', null, proto);
goog.exportSymbol('api.commons.OmniCannedMessage', null, proto);
goog.exportSymbol('api.commons.OmniCloseConversation', null, proto);
goog.exportSymbol('api.commons.OmniComplianceAction', null, proto);
goog.exportSymbol('api.commons.OmniComplianceConfig', null, proto);
goog.exportSymbol('api.commons.OmniConversation', null, proto);
goog.exportSymbol('api.commons.OmniConversation.ConversationDetails', null, proto);
goog.exportSymbol('api.commons.OmniConversationAssignment', null, proto);
goog.exportSymbol('api.commons.OmniConversationAssignment.ConversationAssignmentDetails', null, proto);
goog.exportSymbol('api.commons.OmniConversationMetadataName', null, proto);
goog.exportSymbol('api.commons.OmniConversationResult', null, proto);
goog.exportSymbol('api.commons.OmniConversationSkills', null, proto);
goog.exportSymbol('api.commons.OmniConversationUserInformation', null, proto);
goog.exportSymbol('api.commons.OmniCustomUnsubscribeLink', null, proto);
goog.exportSymbol('api.commons.OmniDataField', null, proto);
goog.exportSymbol('api.commons.OmniDataMessage', null, proto);
goog.exportSymbol('api.commons.OmniFinishWrapUp', null, proto);
goog.exportSymbol('api.commons.OmniMessage', null, proto);
goog.exportSymbol('api.commons.OmniMessagePayload', null, proto);
goog.exportSymbol('api.commons.OmniMessagePayload.PayloadCase', null, proto);
goog.exportSymbol('api.commons.OmniMessageStatus', null, proto);
goog.exportSymbol('api.commons.OmniOffLoadedTextMessage', null, proto);
goog.exportSymbol('api.commons.OmniProjectComplianceConfig', null, proto);
goog.exportSymbol('api.commons.OmniQueueInformation', null, proto);
goog.exportSymbol('api.commons.OmniReassignmentNotification', null, proto);
goog.exportSymbol('api.commons.OmniRequestAttachmentUploadURL', null, proto);
goog.exportSymbol('api.commons.OmniRequestQueueInformation', null, proto);
goog.exportSymbol('api.commons.OmniSenderType', null, proto);
goog.exportSymbol('api.commons.OmniStartWrapUp', null, proto);
goog.exportSymbol('api.commons.OmniSuspend', null, proto);
goog.exportSymbol('api.commons.OmniTask', null, proto);
goog.exportSymbol('api.commons.OmniTask.Details', null, proto);
goog.exportSymbol('api.commons.OmniTaskConfig', null, proto);
goog.exportSymbol('api.commons.OmniTaskState', null, proto);
goog.exportSymbol('api.commons.OmniTaskState.Entry', null, proto);
goog.exportSymbol('api.commons.OmniTaskStatus', null, proto);
goog.exportSymbol('api.commons.OmniTextMessage', null, proto);
goog.exportSymbol('api.commons.OmniTypingNotification', null, proto);
goog.exportSymbol('api.commons.OmniUnassignConversation', null, proto);
goog.exportSymbol('api.commons.ProjectStatus', null, proto);
goog.exportSymbol('api.commons.SLATimeouts', null, proto);
goog.exportSymbol('api.commons.Signature', null, proto);
goog.exportSymbol('api.commons.SmsNumber', null, proto);
goog.exportSymbol('api.commons.SmsNumberProvider', null, proto);
goog.exportSymbol('api.commons.SmsNumberType', null, proto);
goog.exportSymbol('api.commons.VerifiedEmail', null, proto);
goog.exportSymbol('api.commons.WeekdayTimeRange', null, proto);
goog.exportSymbol('api.commons.WeekdayTimeRangeEntry', null, proto);
goog.exportSymbol('api.commons.WhatsAppNumber', null, proto);
goog.exportSymbol('api.commons.WhatsAppNumberProvider', null, proto);
/**
 ...
 * @constructor
 */
proto.api.commons.ConversationTimeoutMessageConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.ConversationTimeoutMessageConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.ConversationTimeoutMessageConfig.displayName = 'proto.api.commons.ConversationTimeoutMessageConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.OmniDataMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.OmniDataMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.OmniDataMessage.displayName = 'proto.api.commons.OmniDataMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.api.commons.OmniCampaignModuleConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 25:
      ...
      break;
    case 26:
      var value = new proto.api.commons.ConversationTimeoutMessageConfig;
      reader.readMessage(value,proto.api.commons.ConversationTimeoutMessageConfig.deserializeBinaryFromReader);
...
proto.api.commons.OmniCampaignModuleConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      26,
      f,
      proto.api.commons.ConversationTimeoutMessageConfig.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ConversationTimeoutMessageConfig timeout_message_config = 26;
 * @return {?proto.api.commons.ConversationTimeoutMessageConfig}
 */
proto.api.commons.OmniCampaignModuleConfig.prototype.getTimeoutMessageConfig = function() {
  return /** @type{?proto.api.commons.ConversationTimeoutMessageConfig} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.ConversationTimeoutMessageConfig, 26));
};


/**
 * @param {?proto.api.commons.ConversationTimeoutMessageConfig|undefined} value
 * @return {!proto.api.commons.OmniCampaignModuleConfig} returns this
*/
proto.api.commons.OmniCampaignModuleConfig.prototype.setTimeoutMessageConfig = function(value) {
 ...
 * @return {!proto.api.commons.OmniCampaignModuleConfig} returns this
 */
proto.api.commons.OmniCampaignModuleConfig.prototype.clearTimeoutMessageConfig = function() {
 ...
 * @return {boolean}
 */
proto.api.commons.OmniCampaignModuleConfig.prototype.hasTimeoutMessageConfig = function() {
 ...
 * @return {!Object}
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.ConversationTimeoutMessageConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.ConversationTimeoutMessageConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.ConversationTimeoutMessageConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.commons.ConversationTimeoutMessageConfig}
 */
proto.api.commons.ConversationTimeoutMessageConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.ConversationTimeoutMessageConfig;
  return proto.api.commons.ConversationTimeoutMessageConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.ConversationTimeoutMessageConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.ConversationTimeoutMessageConfig}
 */
proto.api.commons.ConversationTimeoutMessageConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.ConversationTimeoutMessageConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.ConversationTimeoutMessageConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.ConversationTimeoutMessageConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.getIsDisabled = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.api.commons.ConversationTimeoutMessageConfig} returns this
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.setIsDisabled = function(value) {
 ...
 * @return {string}
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.getMsg = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.commons.ConversationTimeoutMessageConfig} returns this
 */
proto.api.commons.ConversationTimeoutMessageConfig.prototype.setMsg = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @const
 */
proto.api.commons.OmniMessagePayload.oneofGroups_ = [[100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116]];
...
proto.api.commons.OmniMessagePayload.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 115:
      ...
      break;
    case 116:
      var value = new proto.api.commons.OmniDataMessage;
      reader.readMessage(value,proto.api.commons.OmniDataMessage.deserializeBinaryFromReader);
...
proto.api.commons.OmniMessagePayload.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      116,
      f,
      proto.api.commons.OmniDataMessage.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional OmniDataMessage data_message = 116;
 * @return {?proto.api.commons.OmniDataMessage}
 */
proto.api.commons.OmniMessagePayload.prototype.getDataMessage = function() {
  return /** @type{?proto.api.commons.OmniDataMessage} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.OmniDataMessage, 116));
};


/**
 * @param {?proto.api.commons.OmniDataMessage|undefined} value
 * @return {!proto.api.commons.OmniMessagePayload} returns this
*/
proto.api.commons.OmniMessagePayload.prototype.setDataMessage = function(value) {
  return jspb.Message.setOneofWrapperField(this, 116, proto.api.commons.OmniMessagePayload.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.commons.OmniMessagePayload} returns this
 */
proto.api.commons.OmniMessagePayload.prototype.clearDataMessage = function() {
 ...
 * @return {boolean}
 */
proto.api.commons.OmniMessagePayload.prototype.hasDataMessage = function() {
 ...
 * @return {!Object}
 */
proto.api.commons.OmniDataMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.OmniDataMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.OmniDataMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!proto.api.commons.OmniDataMessage}
 */
proto.api.commons.OmniDataMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.OmniDataMessage;
  return proto.api.commons.OmniDataMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.OmniDataMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.OmniDataMessage}
 */
proto.api.commons.OmniDataMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.OmniDataMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.OmniDataMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.OmniDataMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.OmniDataMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMessage();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.commons.OmniDataMessage.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.commons.OmniDataMessage.prototype.setMessage = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
