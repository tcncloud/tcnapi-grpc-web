 ...
 * @constructor
 */
proto.api.commons.TimeZoneWrapper = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.TimeZoneWrapper, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.TimeZoneWrapper.displayName = 'proto.api.commons.TimeZoneWrapper';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.DigitWrapper = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.DigitWrapper, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.DigitWrapper.displayName = 'proto.api.commons.DigitWrapper';
}
 ...
 * @return {!Object}
 */
proto.api.commons.TimeZoneWrapper.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.TimeZoneWrapper.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.TimeZoneWrapper} msg The msg instance to transform.
 * @return {!Object}
 ...
 */
proto.api.commons.TimeZoneWrapper.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.TimeZoneWrapper;
  return proto.api.commons.TimeZoneWrapper.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.api.commons.TimeZoneWrapper} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.TimeZoneWrapper}
 */
proto.api.commons.TimeZoneWrapper.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.TimeZoneWrapper.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.TimeZoneWrapper.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.api.commons.TimeZoneWrapper} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.TimeZoneWrapper.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 */
proto.api.commons.TimeZoneWrapper.prototype.getValue = function() {
  return /** @type {!proto.api.commons.TimeZone} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.api.commons.TimeZone} value
 * @return {!proto.api.commons.TimeZoneWrapper} returns this
 */
proto.api.commons.TimeZoneWrapper.prototype.setValue = function(value) {
 ...
 * @return {!Object}
 */
proto.api.commons.DigitWrapper.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.DigitWrapper.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.DigitWrapper} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.commons.DigitWrapper}
 */
proto.api.commons.DigitWrapper.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.DigitWrapper;
  return proto.api.commons.DigitWrapper.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.DigitWrapper} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.DigitWrapper}
 */
proto.api.commons.DigitWrapper.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.api.commons.Digit} */ (reader.readEnum());
      msg.setValue(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.DigitWrapper.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.DigitWrapper.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.DigitWrapper} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.DigitWrapper.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional Digit value = 1;
 * @return {!proto.api.commons.Digit}
 */
proto.api.commons.DigitWrapper.prototype.getValue = function() {
  return /** @type {!proto.api.commons.Digit} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.api.commons.Digit} value
 * @return {!proto.api.commons.DigitWrapper} returns this
 */
proto.api.commons.DigitWrapper.prototype.setValue = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
 ...
 * @enum {number}
 */
proto.api.commons.DisplayLanguage = {
 ...
 * @enum {number}
 */
proto.api.commons.DefaultDuplicateHandling = {
 ...
 * @enum {number}
 */
proto.api.commons.StandardImportFormat = {
 ...
 * @enum {number}
 */
proto.api.commons.AgentInfoSortBy = {
 ...
 * @enum {number}
 */
proto.api.commons.QueueInfoSortBy = {
 ...
 * @enum {number}
 */
proto.api.commons.AutomaticSystemCode = {
 ...
 * @enum {number}
 */
proto.api.commons.AdvanceStatusType = {
 ...
 * @enum {number}
 */
proto.api.commons.AgentFieldOption = {
 ...
 * @enum {number}
 */
proto.api.commons.PostalFieldOption = {
 ...
 * @enum {number}
 */
proto.api.commons.PhoneFieldOption = {
 ...
 * @enum {number}
 */
proto.api.commons.PhonePostalDisplayOptions = {
 ...
 * @enum {number}
 */
proto.api.commons.OperatorApplications = {
  AGENT_APP: 0,
 ...
 * @enum {number}
 */
proto.api.commons.AnnouncementMixingOption = {
 ...
 * @enum {number}
 */
proto.api.commons.InboundOverrideOption = {
 ...
 * @enum {number}
 */
proto.api.commons.IntercomConnection = {
 ...
 * @enum {number}
 */
proto.api.commons.SoundLanguage = {
 ...
 * @enum {number}
 */
proto.api.commons.IdentityProvider = {
 ...
 * @enum {number}
 */
proto.api.commons.RecordingFileType = {
 ...
 * @enum {number}
 */
proto.api.commons.InitialAgentStatus = {
 ...
 * @enum {number}
 */
proto.api.commons.AgentRouting = {
 ...
 * @enum {number}
 */
proto.api.commons.AlphanumericKeypadDelimiter = {
 ...
 * @enum {number}
 */
proto.api.commons.AgentCallHistoryScope = {
 ...
 * @enum {number}
 */
proto.api.commons.CommunicationExpiration = {
 ...
 * @enum {number}
 */
proto.api.commons.DefaultCallbackRouting = {
 ...
 * @enum {number}
 */
proto.api.commons.XMLPropertyKey = {
 ...
 * @enum {number}
 */
proto.api.commons.DefaultManualCallRecording = {
 ...
 * @enum {number}
 */
proto.api.commons.HuntGroupOrgDefaultCustom = {
 ...
 * @enum {number}
 */
proto.api.commons.ManualDialTimeZoneValidation = {
 ...
 * @enum {number}
 */
proto.api.commons.TransferRecordingStatus = {
 ...
 * @enum {number}
 */
proto.api.commons.RequeueTransferQueueConfig = {
 ...
 * @enum {number}
 */
proto.api.commons.DefaultTransferCallerId = {
 ...
 * @enum {number}
 */
proto.api.commons.DefaultManualDialCallerId = {
 ...
 * @enum {number}
 */
proto.api.commons.ManualDialDataDipScope = {
 ...
 * @enum {number}
 */
proto.api.commons.ManualDialDataDipHandling = {
 ...
 * @enum {number}
 */
proto.api.commons.ManualDialDataDipIntegration = {
 ...
 * @enum {number}
 */
proto.api.commons.DataDipTemplateFilterType = {
 ...
 * @enum {number}
 */
proto.api.commons.OrganizationArchivedStateFilter = {
