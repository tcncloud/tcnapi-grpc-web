// package: api.commons
// file: api/commons/ana.proto

import * as jspb from "google-protobuf";

export interface AnaTimeZoneMap {
...
export const AnaTimeZone: AnaTimeZoneMap;

export interface TimeFilterTypeMap {
...
export const TimeFilterType: TimeFilterTypeMap;

export interface DashPageTypeMap {
...
export const DashPageType: DashPageTypeMap;

export interface FilterByMap {
...
export const FilterBy: FilterByMap;

export interface WallaceDataTypeMap {
...
export const WallaceDataType: WallaceDataTypeMap;
...
export const TimeScope: TimeScopeMap;
...
export interface CsvQuoteTypeMap {
  NO_QUOTE_TYPE: 0;
  SINGLE: 1;
  DOUBLE: 2;
}

export const CsvQuoteType: CsvQuoteTypeMap;

export interface StringComparisonMap {
  STRING_EQ: 0;
  STRING_NEQ: 1;
...
export const StringComparison: StringComparisonMap;

export interface FloatComparisonMap {
  FLOAT_EQ: 0;
  FLOAT_NEQ: 1;
  LT: 2;
  LTE: 3;
...
export const FloatComparison: FloatComparisonMap;

export interface BoolComparisonMap {
  BOOL_EQ: 0;
  BOOL_NEQ: 1;
}

export const BoolComparison: BoolComparisonMap;

export interface DateComparisonMap {
...
export const DateComparison: DateComparisonMap;

export interface CompoundFilterJoinMap {
  AND: 0;
  OR: 1;
}

export const CompoundFilterJoin: CompoundFilterJoinMap;

export interface AnaExportTypeMap {
  ANA_EXPORT_TYPE_EMAIL: 0;
  ANA_EXPORT_TYPE_SFTP: 1;
  ANA_EXPORT_TYPE_HTTPS: 2;
}

export const AnaExportType: AnaExportTypeMap;

export interface ExporterDataSelectionTypeMap {
  CHART_ID_SELECTION_TYPE: 0;
  CUSTOM_SELECTION_TYPE: 1;
}

export const ExporterDataSelectionType: ExporterDataSelectionTypeMap;

export interface NumericAggregationMap {
...
export const NumericAggregation: NumericAggregationMap;

export interface NonNumericAggregationMap {
...
export const NonNumericAggregation: NonNumericAggregationMap;
...
export interface CustomDataSelecitonMap {
  CUSTOM_DATA_SELECTION_UKNOWN: 0;
}

export const CustomDataSeleciton: CustomDataSelecitonMap;

export interface DataPointTypeMap {
...
export const DataPointType: DataPointTypeMap;
...
export const ExportStatus: ExportStatusMap;
