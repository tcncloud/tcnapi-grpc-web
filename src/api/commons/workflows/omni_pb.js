...
goog.exportSymbol('proto.api.commons.workflows.OmniNodeScrublistAction', null, global);
...
proto.api.commons.workflows.OmniNodeScrublist.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.api.commons.workflows.OmniNodeScrublistAction} */ (reader.readEnum());
      msg.setAction(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional OmniNodeScrublistAction action = 1;
 * @return {!proto.api.commons.workflows.OmniNodeScrublistAction}
 */
proto.api.commons.workflows.OmniNodeScrublist.prototype.getAction = function() {
  return /** @type {!proto.api.commons.workflows.OmniNodeScrublistAction} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.api.commons.workflows.OmniNodeScrublistAction} value
 ...
 * @enum {number}
 */
proto.api.commons.workflows.OmniNodeScrublistAction = {
  ADD: 0,
  REMOVE: 1
};
