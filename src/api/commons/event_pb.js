...
goog.exportSymbol('api.commons.ActivatedConversationAsmEvent', null, proto);
goog.exportSymbol('api.commons.ActivatedConversationEvent', null, proto);
goog.exportSymbol('api.commons.AsmEvent', null, proto);
goog.exportSymbol('api.commons.AsmEvent.EventCase', null, proto);
goog.exportSymbol('api.commons.ConversationPulledEvent', null, proto);
goog.exportSymbol('api.commons.DeactivatedConversationAsmEvent', null, proto);
goog.exportSymbol('api.commons.DeactivatedConversationEvent', null, proto);
goog.exportSymbol('api.commons.Event', null, proto);
goog.exportSymbol('api.commons.Event.EventCase', null, proto);
goog.exportSymbol('api.commons.PauseEvent', null, proto);
goog.exportSymbol('api.commons.ResumeEvent', null, proto);
goog.exportSymbol('api.commons.SendStatusAsmEvent', null, proto);
goog.exportSymbol('api.commons.SendStatusEvent', null, proto);
goog.exportSymbol('api.commons.SentMessageAsmEvent', null, proto);
goog.exportSymbol('api.commons.SentMessageEvent', null, proto);
/**
 ...
 * @constructor
 */
proto.api.commons.ConversationPulledEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.ConversationPulledEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.ConversationPulledEvent.displayName = 'proto.api.commons.ConversationPulledEvent';
}
 ...
 * @const
 */
proto.api.commons.AsmEvent.oneofGroups_ = [[5,6,7,8,9,10,11]];
...
proto.api.commons.AsmEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new proto.api.commons.ConversationPulledEvent;
      reader.readMessage(value,proto.api.commons.ConversationPulledEvent.deserializeBinaryFromReader);
      msg.setConversationPulledEvent(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.api.commons.AsmEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getConversationPulledEvent();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.api.commons.ConversationPulledEvent.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ConversationPulledEvent conversation_pulled_event = 11;
 * @return {?proto.api.commons.ConversationPulledEvent}
 */
proto.api.commons.AsmEvent.prototype.getConversationPulledEvent = function() {
  return /** @type{?proto.api.commons.ConversationPulledEvent} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.ConversationPulledEvent, 11));
};


/**
 * @param {?proto.api.commons.ConversationPulledEvent|undefined} value
 * @return {!proto.api.commons.AsmEvent} returns this
*/
proto.api.commons.AsmEvent.prototype.setConversationPulledEvent = function(value) {
  return jspb.Message.setOneofWrapperField(this, 11, proto.api.commons.AsmEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.api.commons.AsmEvent} returns this
 */
proto.api.commons.AsmEvent.prototype.clearConversationPulledEvent = function() {
  return this.setConversationPulledEvent(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.commons.AsmEvent.prototype.hasConversationPulledEvent = function() {
 ...
 * @return {!Object}
 */
proto.api.commons.ConversationPulledEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.ConversationPulledEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.ConversationPulledEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!proto.api.commons.ConversationPulledEvent}
 */
proto.api.commons.ConversationPulledEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.ConversationPulledEvent;
  return proto.api.commons.ConversationPulledEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.ConversationPulledEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.ConversationPulledEvent}
 */
proto.api.commons.ConversationPulledEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.ConversationPulledEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.ConversationPulledEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.ConversationPulledEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.ConversationPulledEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getConversation();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.api.commons.OmniConversation}
 */
proto.api.commons.ConversationPulledEvent.prototype.getConversation = function() {
  return /** @type{?proto.api.commons.OmniConversation} */ (
    jspb.Message.getWrapperField(this, api_commons_omnichannel_pb.OmniConversation, 1));
};
...
/**
 * @param {?proto.api.commons.OmniConversation|undefined} value
 * @return {!proto.api.commons.ConversationPulledEvent} returns this
*/
proto.api.commons.ConversationPulledEvent.prototype.setConversation = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.commons.ConversationPulledEvent} returns this
 */
proto.api.commons.ConversationPulledEvent.prototype.clearConversation = function() {
  return this.setConversation(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.commons.ConversationPulledEvent.prototype.hasConversation = function() {
  return jspb.Message.getField(this, 1) != null;
};
