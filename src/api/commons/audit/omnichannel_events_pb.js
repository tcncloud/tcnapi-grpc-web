...
goog.exportSymbol('proto.api.commons.audit.OmnichannelProviderMessageFailedEvent', null, global);
 ...
 * @constructor
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.audit.OmnichannelTranscriptSavedEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.audit.OmnichannelTranscriptSavedEvent.displayName = 'proto.api.commons.audit.OmnichannelTranscriptSavedEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.audit.OmnichannelProviderResponseEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.audit.OmnichannelProviderResponseEvent.displayName = 'proto.api.commons.audit.OmnichannelProviderResponseEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.audit.OmnichannelProviderMessageFailedEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.displayName = 'proto.api.commons.audit.OmnichannelProviderMessageFailedEvent';
}
 ...
 * @return {!Object}
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.audit.OmnichannelTranscriptSavedEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.audit.OmnichannelTranscriptSavedEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.audit.OmnichannelTranscriptSavedEvent;
  return proto.api.commons.audit.OmnichannelTranscriptSavedEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.audit.OmnichannelTranscriptSavedEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.audit.OmnichannelTranscriptSavedEvent}
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.audit.OmnichannelTranscriptSavedEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.audit.OmnichannelTranscriptSavedEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getConversationSid();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.prototype.getConversationSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.prototype.setConversationSid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelTranscriptSavedEvent.prototype.getTranscriptPath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
channelType: jspb.Message.getFieldWithDefault(msg, 2, 0),
sentFrom: jspb.Message.getFieldWithDefault(msg, 3, ""),
sentTo: jspb.Message.getFieldWithDefault(msg, 4, ""),
...
/**
 * optional int64 attachment_size = 6;
 * @return {number}
 */
...
/**
 * optional api.commons.OmniSenderType sender_type = 7;
...
proto.api.commons.audit.OmnichannelMessageSentEvent.prototype.getSenderType = function() {
  return /** @type {!proto.api.commons.OmniSenderType} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!Object}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.audit.OmnichannelProviderResponseEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.audit.OmnichannelProviderResponseEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
omniMessageSid: jspb.Message.getFieldWithDefault(msg, 1, 0),
channelType: jspb.Message.getFieldWithDefault(msg, 2, 0),
sentFrom: jspb.Message.getFieldWithDefault(msg, 3, ""),
sentTo: jspb.Message.getFieldWithDefault(msg, 4, ""),
messageSize: jspb.Message.getFieldWithDefault(msg, 5, 0),
 ...
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.audit.OmnichannelProviderResponseEvent;
  return proto.api.commons.audit.OmnichannelProviderResponseEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.audit.OmnichannelProviderResponseEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.audit.OmnichannelProviderResponseEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.audit.OmnichannelProviderResponseEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOmniMessageSid();
  if (f !== 0) {
    writer.writeInt64(
      1,
      f
  ...
  f = message.getProviderMessageCount();
  if (f !== 0) {
    writer.writeInt64(
      9,
      f
...
/**
 * optional int64 omni_message_sid = 1;
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getOmniMessageSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setOmniMessageSid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.api.commons.ChannelType}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getChannelType = function() {
  return /** @type {!proto.api.commons.ChannelType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setChannelType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getSentFrom = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setSentFrom = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getSentTo = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setSentTo = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getMessageSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setMessageSize = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getAttachmentSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setAttachmentSize = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};
 ...
 * @return {!proto.api.commons.OmniSenderType}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getSenderType = function() {
  return /** @type {!proto.api.commons.OmniSenderType} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setSenderType = function(value) {
  return jspb.Message.setProto3EnumField(this, 7, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderResponseEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};


/**
 * optional int64 provider_message_count = 9;
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderResponseEvent.prototype.getProviderMessageCount = function() {
 ...
 * @return {!Object}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
omniMessageSid: jspb.Message.getFieldWithDefault(msg, 1, 0),
channelType: jspb.Message.getFieldWithDefault(msg, 2, 0),
sentFrom: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.audit.OmnichannelProviderMessageFailedEvent;
  return proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOmniMessageSid();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getOmniMessageSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setOmniMessageSid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.api.commons.ChannelType}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getChannelType = function() {
  return /** @type {!proto.api.commons.ChannelType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setChannelType = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getSentFrom = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setSentFrom = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getSentTo = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setSentTo = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getMessageSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setMessageSize = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getAttachmentSize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setAttachmentSize = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};
 ...
 * @return {!proto.api.commons.OmniSenderType}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getSenderType = function() {
  return /** @type {!proto.api.commons.OmniSenderType} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setSenderType = function(value) {
  return jspb.Message.setProto3EnumField(this, 7, value);
};
 ...
 * @return {string}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};
 ...
 * @return {number}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getProviderMessageCount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};
 ...
 * @return {!proto.api.commons.audit.OmnichannelProviderMessageFailedEvent} returns this
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.setProviderMessageCount = function(value) {
  return jspb.Message.setProto3IntField(this, 9, value);
};
 ...
 * @return {!proto.api.commons.OmniMessageType}
 */
proto.api.commons.audit.OmnichannelProviderMessageFailedEvent.prototype.getMessageType = function() {
  return /** @type {!proto.api.commons.OmniMessageType} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};
