// package: api.commons
// file: api/commons/email.proto

import * as jspb from "google-protobuf";

export interface EmailResultMap {
...
export const EmailResult: EmailResultMap;
...
export interface EmailIBGroupStatusMap {
...
export const EmailIBGroupStatus: EmailIBGroupStatusMap;

export interface EmailIBReplyStatusMap {
...
export const EmailIBReplyStatus: EmailIBReplyStatusMap;

export interface EmailIBGroupEventMap {
...
export const EmailIBGroupEvent: EmailIBGroupEventMap;

export interface EmailIBReplyTypeMap {
  REPLY_UNKNOWN: 0;
  EXISTING_CONV: 1;
  OUTBOUND_REPLY: 2;
  AGENT_REPLY: 3;
...
export const EmailIBReplyType: EmailIBReplyTypeMap;
