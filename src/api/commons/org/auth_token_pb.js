...
goog.exportSymbol('proto.api.commons.org.AuthTokenNotification', null, global);
/**
 ...
 * @constructor
 */
proto.api.commons.org.AuthTokenNotification = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.org.AuthTokenNotification, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.org.AuthTokenNotification.displayName = 'proto.api.commons.org.AuthTokenNotification';
}
 ...
 * @return {!Object}
 */
proto.api.commons.org.AuthTokenNotification.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.org.AuthTokenNotification.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.org.AuthTokenNotification} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.AuthTokenNotification.toObject = function(includeInstance, msg) {
  var f, obj = {
    token: jspb.Message.getFieldWithDefault(msg, 1, ""),
    expiration: (f = msg.getExpiration()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
 ...
 */
proto.api.commons.org.AuthTokenNotification.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.org.AuthTokenNotification;
  return proto.api.commons.org.AuthTokenNotification.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.org.AuthTokenNotification} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.org.AuthTokenNotification}
 */
proto.api.commons.org.AuthTokenNotification.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.org.AuthTokenNotification.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.org.AuthTokenNotification.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.org.AuthTokenNotification} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.AuthTokenNotification.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getToken();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.commons.org.AuthTokenNotification.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.commons.org.AuthTokenNotification} returns this
 */
proto.api.commons.org.AuthTokenNotification.prototype.setToken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.api.commons.org.AuthTokenNotification.prototype.getExpiration = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.api.commons.org.AuthTokenNotification} returns this
*/
proto.api.commons.org.AuthTokenNotification.prototype.setExpiration = function(value) {
 ...
 * @return {!proto.api.commons.org.AuthTokenNotification} returns this
 */
proto.api.commons.org.AuthTokenNotification.prototype.clearExpiration = function() {
  return this.setExpiration(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.commons.org.AuthTokenNotification.prototype.hasExpiration = function() {
