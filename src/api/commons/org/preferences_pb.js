...
goog.exportSymbol('proto.api.commons.org.VoiceAnalytics.Number.Phrase', null, global);
goog.exportSymbol('proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word', null, global);
goog.exportSymbol('proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity', null, global);
goog.exportSymbol('proto.api.commons.org.VoiceAnalytics.Number.Proximity', null, global);
 ...
 * @constructor
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.displayName = 'proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.commons.org.VoiceAnalytics.Number.Phrase.repeatedFields_, null);
};
goog.inherits(proto.api.commons.org.VoiceAnalytics.Number.Phrase, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.org.VoiceAnalytics.Number.Phrase.displayName = 'proto.api.commons.org.VoiceAnalytics.Number.Phrase';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.displayName = 'proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.org.VoiceAnalytics.Number.Proximity, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.org.VoiceAnalytics.Number.Proximity.displayName = 'proto.api.commons.org.VoiceAnalytics.Number.Proximity';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
phraseProximity: (f = msg.getPhraseProximity()) && proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.toObject(includeInstance, f)
  };
...
proto.api.commons.org.VoiceAnalytics.Number.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity;
      reader.readMessage(value,proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.deserializeBinaryFromReader);
      msg.setPhraseProximity(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.api.commons.org.VoiceAnalytics.Number.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPhraseProximity();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.toObject = function(includeInstance, msg) {
  var f, obj = {
phrase: (f = msg.getPhrase()) && proto.api.commons.org.VoiceAnalytics.Number.Phrase.toObject(includeInstance, f),
proximity: (f = msg.getProximity()) && proto.api.commons.org.VoiceAnalytics.Number.Proximity.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity;
  return proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.commons.org.VoiceAnalytics.Number.Phrase;
      reader.readMessage(value,proto.api.commons.org.VoiceAnalytics.Number.Phrase.deserializeBinaryFromReader);
      msg.setPhrase(value);
      break;
    case 2:
      var value = new proto.api.commons.org.VoiceAnalytics.Number.Proximity;
      reader.readMessage(value,proto.api.commons.org.VoiceAnalytics.Number.Proximity.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPhrase();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.api.commons.org.VoiceAnalytics.Number.Phrase.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.api.commons.org.VoiceAnalytics.Number.Proximity.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.api.commons.org.VoiceAnalytics.Number.Phrase}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.getPhrase = function() {
  return /** @type{?proto.api.commons.org.VoiceAnalytics.Number.Phrase} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.org.VoiceAnalytics.Number.Phrase, 1));
};


/**
 * @param {?proto.api.commons.org.VoiceAnalytics.Number.Phrase|undefined} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} returns this
*/
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.setPhrase = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.clearPhrase = function() {
 ...
 * @return {boolean}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.hasPhrase = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.api.commons.org.VoiceAnalytics.Number.Proximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.getProximity = function() {
  return /** @type{?proto.api.commons.org.VoiceAnalytics.Number.Proximity} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.org.VoiceAnalytics.Number.Proximity, 2));
};


/**
 * @param {?proto.api.commons.org.VoiceAnalytics.Number.Proximity|undefined} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} returns this
*/
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.setProximity = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.clearProximity = function() {
 ...
 * @return {boolean}
 */
proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity.prototype.hasProximity = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @const
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.org.VoiceAnalytics.Number.Phrase.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.org.VoiceAnalytics.Number.Phrase;
  return proto.api.commons.org.VoiceAnalytics.Number.Phrase.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word;
      reader.readMessage(value,proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.deserializeBinaryFromReader);
      msg.addWords(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.org.VoiceAnalytics.Number.Phrase.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.serializeBinaryToWriter
    );
  }
  f = message.getSlop();
  if (f !== 0) {
 ...
 * @return {!Object}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word;
  return proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.setValue = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.getFuzziness = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word.prototype.setFuzziness = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Array<!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word>}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.getWordsList = function() {
  return /** @type{!Array<!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word, 1));
};


/**
 * @param {!Array<!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word>} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} returns this
*/
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.setWordsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.addWords = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.commons.org.VoiceAnalytics.Number.Phrase.Word, opt_index);
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.clearWordsList = function() {
 ...
 * @return {number}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.getSlop = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Phrase} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.setSlop = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.api.commons.org.VoiceAnalytics.Number.Phrase.prototype.getInOrder = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 3, false));
};
 ...
 * @return {!Object}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.org.VoiceAnalytics.Number.Proximity.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Proximity} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Proximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.org.VoiceAnalytics.Number.Proximity;
  return proto.api.commons.org.VoiceAnalytics.Number.Proximity.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Proximity} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Proximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.org.VoiceAnalytics.Number.Proximity.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.org.VoiceAnalytics.Number.Proximity} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBefore();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.getBefore = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Proximity} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.setBefore = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.getAfter = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number.Proximity} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.Proximity.prototype.setAfter = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
...
/**
 * optional PhraseProximity phrase_proximity = 5;
 * @return {?proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity}
 */
proto.api.commons.org.VoiceAnalytics.Number.prototype.getPhraseProximity = function() {
  return /** @type{?proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity} */ (
    jspb.Message.getWrapperField(this, proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity, 5));
};


/**
 * @param {?proto.api.commons.org.VoiceAnalytics.Number.PhraseProximity|undefined} value
 * @return {!proto.api.commons.org.VoiceAnalytics.Number} returns this
*/
proto.api.commons.org.VoiceAnalytics.Number.prototype.setPhraseProximity = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.api.commons.org.VoiceAnalytics.Number} returns this
 */
proto.api.commons.org.VoiceAnalytics.Number.prototype.clearPhraseProximity = function() {
  return this.setPhraseProximity(undefined);
};
 ...
 * @return {boolean}
 */
proto.api.commons.org.VoiceAnalytics.Number.prototype.hasPhraseProximity = function() {
  return jspb.Message.getField(this, 5) != null;
};
