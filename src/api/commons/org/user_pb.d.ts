...
export namespace MfaInfo {
  ...
  export class TotpType extends jspb.Message {
    getAuthenticatorType(): TotpAuthenticatorTypeMap[keyof TotpAuthenticatorTypeMap];
    setAuthenticatorType(value: TotpAuthenticatorTypeMap[keyof TotpAuthenticatorTypeMap]): void;
  ...
  export namespace TotpType {
    export type AsObject = {
      authenticatorType: TotpAuthenticatorTypeMap[keyof TotpAuthenticatorTypeMap],
      secretKey: string,
    }
  }
...
export interface TotpAuthenticatorTypeMap {
...
export const TotpAuthenticatorType: TotpAuthenticatorTypeMap;
