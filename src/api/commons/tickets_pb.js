...
goog.exportSymbol('proto.api.commons.TemplateDetail', null, global);
 ...
 * @constructor
 */
proto.api.commons.TemplateDetail = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.commons.TemplateDetail, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.commons.TemplateDetail.displayName = 'proto.api.commons.TemplateDetail';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.api.commons.AssignProjectTemplate.repeatedFields_ = [1,3];
...
proto.api.commons.AssignProjectTemplate.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    templateDetailsList: jspb.Message.toObjectList(msg.getTemplateDetailsList(),
    proto.api.commons.TemplateDetail.toObject, includeInstance)
  };
...
proto.api.commons.AssignProjectTemplate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.api.commons.TemplateDetail;
      reader.readMessage(value,proto.api.commons.TemplateDetail.deserializeBinaryFromReader);
      msg.addTemplateDetails(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.api.commons.AssignProjectTemplate.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTemplateDetailsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.api.commons.TemplateDetail.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated TemplateDetail template_details = 3;
 * @return {!Array<!proto.api.commons.TemplateDetail>}
 */
proto.api.commons.AssignProjectTemplate.prototype.getTemplateDetailsList = function() {
  return /** @type{!Array<!proto.api.commons.TemplateDetail>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.commons.TemplateDetail, 3));
};


/**
 * @param {!Array<!proto.api.commons.TemplateDetail>} value
 * @return {!proto.api.commons.AssignProjectTemplate} returns this
*/
proto.api.commons.AssignProjectTemplate.prototype.setTemplateDetailsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.api.commons.TemplateDetail=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.commons.TemplateDetail}
 */
proto.api.commons.AssignProjectTemplate.prototype.addTemplateDetails = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.api.commons.TemplateDetail, opt_index);
};
 ...
 * @return {!proto.api.commons.AssignProjectTemplate} returns this
 */
proto.api.commons.AssignProjectTemplate.prototype.clearTemplateDetailsList = function() {
  return this.setTemplateDetailsList([]);
};
 ...
 * @return {!Object}
 */
proto.api.commons.TemplateDetail.prototype.toObject = function(opt_includeInstance) {
  return proto.api.commons.TemplateDetail.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.commons.TemplateDetail} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.TemplateDetail.toObject = function(includeInstance, msg) {
  var f, obj = {
    ticketTemplateId: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    ticketTemplateTitle: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.api.commons.TemplateDetail}
 */
proto.api.commons.TemplateDetail.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.commons.TemplateDetail;
  return proto.api.commons.TemplateDetail.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.commons.TemplateDetail} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.commons.TemplateDetail}
 */
proto.api.commons.TemplateDetail.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setTicketTemplateTitle(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.api.commons.TemplateDetail.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.commons.TemplateDetail.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.commons.TemplateDetail} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.commons.TemplateDetail.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTicketTemplateId();
  if (parseInt(f, 10) !== 0) {
    writer.writeInt64String(
  ...
  f = message.getTicketTemplateTitle();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
 ...
 * @return {string}
 */
proto.api.commons.TemplateDetail.prototype.getTicketTemplateId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.api.commons.TemplateDetail} returns this
 */
proto.api.commons.TemplateDetail.prototype.setTicketTemplateId = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};


/**
 * optional string ticket_template_title = 2;
 * @return {string}
 */
proto.api.commons.TemplateDetail.prototype.getTicketTemplateTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.commons.TemplateDetail} returns this
 */
proto.api.commons.TemplateDetail.prototype.setTicketTemplateTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
