...
goog.exportSymbol('api.commons.ActionType', null, proto);
goog.exportSymbol('api.commons.AssignProjectTemplate', null, proto);
goog.exportSymbol('api.commons.CallbackContext', null, proto);
goog.exportSymbol('api.commons.CloseTicket', null, proto);
goog.exportSymbol('api.commons.Comment', null, proto);
goog.exportSymbol('api.commons.ConfirmClose', null, proto);
goog.exportSymbol('api.commons.ConfirmReplyComment', null, proto);
goog.exportSymbol('api.commons.Duration', null, proto);
goog.exportSymbol('api.commons.EditAttribute', null, proto);
goog.exportSymbol('api.commons.EditTicket', null, proto);
goog.exportSymbol('api.commons.EmailbackContext', null, proto);
goog.exportSymbol('api.commons.ListTemplate', null, proto);
goog.exportSymbol('api.commons.Metadata', null, proto);
goog.exportSymbol('api.commons.PhoneNumberType', null, proto);
goog.exportSymbol('api.commons.ProjectDescription', null, proto);
goog.exportSymbol('api.commons.ReplyComment', null, proto);
goog.exportSymbol('api.commons.Skills', null, proto);
goog.exportSymbol('api.commons.Sla', null, proto);
goog.exportSymbol('api.commons.SlaConditions', null, proto);
goog.exportSymbol('api.commons.SmsbackContext', null, proto);
goog.exportSymbol('api.commons.TemplateDescription', null, proto);
goog.exportSymbol('api.commons.Ticket', null, proto);
goog.exportSymbol('api.commons.TicketAction', null, proto);
goog.exportSymbol('api.commons.TicketAction.ContextCase', null, proto);
goog.exportSymbol('api.commons.TicketAuditLog', null, proto);
goog.exportSymbol('api.commons.TicketProject', null, proto);
goog.exportSymbol('api.commons.TicketProjectTemplate', null, proto);
goog.exportSymbol('api.commons.TicketSla', null, proto);
goog.exportSymbol('api.commons.TicketStatus', null, proto);
goog.exportSymbol('api.commons.TicketTemplate', null, proto);
goog.exportSymbol('api.commons.TimeScale', null, proto);
/**
