// package: api.commons
// file: api/commons/classifier.proto
...
export namespace FileTemplate {
  ...
  export class Field extends jspb.Message {
    ...
    getEntityType(): ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap];
    setEntityType(value: ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap]): void;
  ...
  export namespace Field {
    export type AsObject = {
      syntaxType: string,
      entityType: ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap],
      name: string,
      format: string,
      rawValue: string,
    }
...
export class ClassifierEntityTypes extends jspb.Message {
  clearTypesList(): void;
  getTypesList(): Array<ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap]>;
  setTypesList(value: Array<ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap]>): void;
  addTypes(value: ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap], index?: number): ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap];
...
export namespace ClassifierEntityTypes {
  export type AsObject = {
    typesList: Array<ClassifierEntityTypeMap[keyof ClassifierEntityTypeMap]>,
  }
}
...
export interface ClassifierEntityTypeMap {
  CET_UNKNOWN: 0;
  CET_CREDIT_CARD: 1;
  CET_CRYPTO: 2;
  CET_DATE_TIME: 3;
