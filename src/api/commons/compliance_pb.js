...
proto.api.commons.WeekdayExp.toObject = function(includeInstance, msg) {
  var f, obj = {
    day: (f = msg.getDay()) && api_commons_enums_pb.Weekday.toObject(includeInstance, f),
...
proto.api.commons.WeekdayExp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new api_commons_enums_pb.Weekday;
      reader.readMessage(value,api_commons_enums_pb.Weekday.deserializeBinaryFromReader);
      msg.setDay(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.api.commons.WeekdayExp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      api_commons_enums_pb.Weekday.serializeBinaryToWriter
    );
  }
  f = message.getText();
  if (f.length > 0) {
...
proto.api.commons.WeekdayExp.prototype.getDay = function() {
  return /** @type{?proto.api.commons.Weekday} */ (
    jspb.Message.getWrapperField(this, api_commons_enums_pb.Weekday, 1));
};


/**
 * @param {?proto.api.commons.Weekday|undefined} value
 ...
 * @return {!proto.api.commons.WeekdayExp} returns this
 */
proto.api.commons.WeekdayExp.prototype.clearDay = function() {
 ...
 * @return {boolean}
 */
proto.api.commons.WeekdayExp.prototype.hasDay = function() {
