...
goog.exportSymbol('api.commons.ChatCampaignEvent', null, proto);
goog.exportSymbol('api.commons.ChatCampaignStatus', null, proto);
goog.exportSymbol('api.commons.ChatColorProperties', null, proto);
goog.exportSymbol('api.commons.ChatHeader', null, proto);
goog.exportSymbol('api.commons.ChatMessageSenderType', null, proto);
goog.exportSymbol('api.commons.ChatMessageType', null, proto);
goog.exportSymbol('api.commons.HoursOfOperation', null, proto);
goog.exportSymbol('api.commons.HoursOfOperationRange', null, proto);
/**
