// package: api.commons
// file: api/commons/manager.proto

import * as jspb from "google-protobuf";

export interface AgentInfoMap {
...
export const AgentInfo: AgentInfoMap;

export interface SkillStatsMap {
...
export const SkillStats: SkillStatsMap;

export interface SkillQueuesMap {
...
export const SkillQueues: SkillQueuesMap;
...
export const AgentStats: AgentStatsMap;

export interface ManagerBargeInModeMap {
  MONITOR: 0;
  FULL_CONFERENCE: 1;
  AGENT_WHISPER: 2;
}

export const ManagerBargeInMode: ManagerBargeInModeMap;
